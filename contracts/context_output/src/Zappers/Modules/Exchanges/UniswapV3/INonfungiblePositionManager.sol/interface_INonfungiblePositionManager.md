...
- **Type**: Interface
- **Path**: src/Zappers/Modules/Exchanges/UniswapV3/INonfungiblePositionManager.sol
- **Documentation**: @title Non-fungible token for positions
   @notice Wraps Uniswap V3 positions in a non-fungible token interface which allows for them to be transferred
   and authorized.

## Implements Interfaces

- **IPoolInitializer** [src/Zappers/Modules/Exchanges/UniswapV3/IPoolInitializer.sol/interface_IPoolInitializer.md]
...
### createAndInitializePoolIfNecessary(address,address,uint24,uint160) (inherited from IPoolInitializer)
