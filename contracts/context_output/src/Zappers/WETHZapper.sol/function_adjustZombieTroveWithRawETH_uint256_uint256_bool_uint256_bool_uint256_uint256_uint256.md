# Function: adjustZombieTroveWithRawETH(uint256,uint256,bool,uint256,bool,uint256,uint256,uint256)
...
- **IBorrowerOperations::adjustZombieTrove(uint256,uint256,bool,uint256,bool,uint256,uint256,uint256)**
- **unknown::unknown**
...
```
┌─ [0] ⚙️ FUNCTION: WETHZapper.adjustZombieTroveWithRawETH(uint256,uint256,bool,uint256,bool,uint256,uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
