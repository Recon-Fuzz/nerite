...
```
┌─ [0] ⚙️ FUNCTION: ERC721.safeTransferFrom(address,address,uint256,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: ERC721._isApprovedOrOwner(address,uint256) (NodeID: 1)
  │   💬 Args: [_msgSender(), tokenId]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Context._msgSender() (NodeID: 9)
  │ │   💬 Args: [no args]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: ERC721.ownerOf(uint256) (NodeID: 2)
  │ │   💬 Args: [tokenId]
  │ │   👁️  Def: public
  │ │ └─ [3] ⚙️ FUNCTION: ERC721._ownerOf(uint256) (NodeID: 3)
  │ │     💬 Args: [tokenId]
  │ │     👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: ERC721.getApproved(uint256) (NodeID: 4)
  │ │   💬 Args: [tokenId]
  │ │   👁️  Def: public
  │ │ └─ [3] ⚙️ FUNCTION: ERC721._requireMinted(uint256) (NodeID: 5)
  │ │     💬 Args: [tokenId]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: ERC721._exists(uint256) (NodeID: 6)
  │ │       💬 Args: [tokenId]
  │ │       👁️  Def: internal
  │ │     └─ [5] ⚙️ FUNCTION: ERC721._ownerOf(uint256) (NodeID: 7)
  │ │         💬 Args: [tokenId]
  │ │         👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: ERC721.isApprovedForAll(address,address) (NodeID: 8)
  │     💬 Args: [owner, spender]
  │     👁️  Def: public
  └─ [1] ⚙️ FUNCTION: ERC721._safeTransfer(address,address,uint256,bytes) (NodeID: 10)
      💬 Args: [from, to, tokenId, data]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ERC721._transfer(address,address,uint256) (NodeID: 11)
    │   💬 Args: [from, to, tokenId]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ERC721.ownerOf(uint256) (NodeID: 12)
    │ │   💬 Args: [tokenId]
    │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: ERC721._ownerOf(uint256) (NodeID: 13)
    │ │     💬 Args: [tokenId]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ERC721._beforeTokenTransfer(address,address,uint256,uint256) (NodeID: 14)
    │ │   💬 Args: [from, to, tokenId, 1]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ERC721.ownerOf(uint256) (NodeID: 15)
    │ │   💬 Args: [tokenId]
    │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: ERC721._ownerOf(uint256) (NodeID: 16)
    │ │     💬 Args: [tokenId]
    │ │     👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: ERC721._afterTokenTransfer(address,address,uint256,uint256) (NodeID: 17)
    │     💬 Args: [from, to, tokenId, 1]
    │     👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: ERC721._checkOnERC721Received(address,address,uint256,bytes) (NodeID: 18)
        💬 Args: [from, to, tokenId, data]
        👁️  Def: private
