...
### collateralRegistryAddress() (inherited from IBoldTokenCustom)
...
### setBranchAddresses(address,address,address,address) (inherited from IBoldTokenCustom)
...
### setCollateralRegistry(address) (inherited from IBoldTokenCustom)
...
### mint(address,uint256) (inherited from IBoldTokenCustom)
...
### burn(address,uint256) (inherited from IBoldTokenCustom)
...
### sendToPool(address,address,uint256) (inherited from IBoldTokenCustom)
...
### returnFromPool(address,address,uint256) (inherited from IBoldTokenCustom)
