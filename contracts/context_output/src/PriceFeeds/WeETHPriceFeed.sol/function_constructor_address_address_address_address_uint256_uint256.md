...
```
┌─ [0] 🏗️ CONSTRUCTOR: WeETHPriceFeed.constructor(address,address,address,address,uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    🏗️  Contract: WeETHPriceFeed
  ...
  └─ [1] 🏗️ CONSTRUCTOR: CompositePriceFeed.constructor(address,address,address,uint256) (NodeID: 20)
      💬 Args: [_owner, _ethUsdOracleAddress, _weEthTokenAddress, _ethUsdStalenessThreshold]
