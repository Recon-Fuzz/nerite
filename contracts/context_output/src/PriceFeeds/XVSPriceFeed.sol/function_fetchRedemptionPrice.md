...
- **Kind**: internal
- **Source**: 469:423:270
- **Link**: `src/PriceFeeds/XVSPriceFeed.sol:XVSPriceFeed:fetchPrice()`
...
```
┌─ [0] ⚙️ FUNCTION: XVSPriceFeed.fetchRedemptionPrice() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: XVSPriceFeed.fetchPrice() (NodeID: 1)
      💬 Args: [no args]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: XVSPriceFeed._fetchPricePrimary() (NodeID: 2)
        💬 Args: [no args]
        👁️  Def: internal
