...
- **Visibility**: public
- **Source Range**: 144:319:270

## Implementation

```solidity
constructor(address _owner, address _xvsUsdOracleAddress, uint256 _xvsUsdStalenessThreshold) TokenPriceFeedBase(_owner,_xvsUsdOracleAddress,_xvsUsdStalenessThreshold) {
    _fetchPricePrimary();
...
- **Kind**: internal
- **Source**: 1359:537:270
- **Link**: `src/PriceFeeds/XVSPriceFeed.sol:XVSPriceFeed:_fetchPricePrimary()`
...
```
┌─ [0] 🏗️ CONSTRUCTOR: XVSPriceFeed.constructor(address,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    🏗️  Contract: XVSPriceFeed
  ├─ [1] ⚙️ FUNCTION: XVSPriceFeed._fetchPricePrimary() (NodeID: 1)
  │   💬 Args: [no args]
  │   👁️  Def: internal
  ...
  └─ [1] 🏗️ CONSTRUCTOR: TokenPriceFeedBase.constructor(address,address,uint256) (NodeID: 7)
      💬 Args: [_owner, _xvsUsdOracleAddress, _xvsUsdStalenessThreshold]
