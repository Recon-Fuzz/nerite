...
```
┌─ [0] 🏗️ CONSTRUCTOR: WSTETHPriceFeed.constructor(address,address,address,address,uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
  ...
  │     👁️  Def: internal
  └─ [1] 🏗️ CONSTRUCTOR: CompositePriceFeed.constructor(address,address,address,uint256) (NodeID: 19)
      💬 Args: [_owner, _ethUsdOracleAddress, _wstEthTokenAddress, _ethUsdStalenessThreshold]
      🏗️  Contract: CompositePriceFeed
    └─ [2] 🏗️ CONSTRUCTOR: MainnetPriceFeedBase.constructor(address,address,uint256) (NodeID: 20)
        💬 Args: [_owner, _ethUsdOracleAddress, _ethUsdStalenessThreshold]
        🏗️  Contract: MainnetPriceFeedBase
      └─ [3] 🏗️ CONSTRUCTOR: Ownable.constructor(address) (NodeID: 21)
          💬 Args: [_owner]
          🏗️  Contract: Ownable
```
