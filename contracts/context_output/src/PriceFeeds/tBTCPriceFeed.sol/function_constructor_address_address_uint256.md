...
```
┌─ [0] 🏗️ CONSTRUCTOR: tBTCPriceFeed.constructor(address,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    🏗️  Contract: tBTCPriceFeed
  ├─ [1] ⚙️ FUNCTION: tBTCPriceFeed._fetchPricePrimary() (NodeID: 1)
  │   💬 Args: [no args]
  │   👁️  Def: internal
  ...
  └─ [1] 🏗️ CONSTRUCTOR: TokenPriceFeedBase.constructor(address,address,uint256) (NodeID: 7)
      💬 Args: [_owner, _tBTCUsdOracleAddress, _tBTCUsdStalenessThreshold]
