...
**Contract**: [src/PriceFeeds/tBTCPriceFeed.sol/contract_tBTCPriceFeed.md]
...
- **Kind**: internal
- **Source**: 475:423:120
- **Link**: `src/PriceFeeds/tBTCPriceFeed.sol:tBTCPriceFeed:fetchPrice()`
...
- **Kind**: internal
- **Source**: 1370:539:120
- **Link**: `src/PriceFeeds/tBTCPriceFeed.sol:tBTCPriceFeed:_fetchPricePrimary()`
...
```
┌─ [0] ⚙️ FUNCTION: tBTCPriceFeed.fetchRedemptionPrice() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: tBTCPriceFeed.fetchPrice() (NodeID: 1)
      💬 Args: [no args]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: tBTCPriceFeed._fetchPricePrimary() (NodeID: 2)
        💬 Args: [no args]
        👁️  Def: internal
