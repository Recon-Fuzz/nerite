...
- **Kind**: internal
- **Source**: 468:423:115
- **Link**: `src/PriceFeeds/UNIPriceFeed.sol:UNIPriceFeed:fetchPrice()`
...
```
┌─ [0] ⚙️ FUNCTION: UNIPriceFeed.fetchRedemptionPrice() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: UNIPriceFeed.fetchPrice() (NodeID: 1)
      💬 Args: [no args]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: UNIPriceFeed._fetchPricePrimary() (NodeID: 2)
        💬 Args: [no args]
        👁️  Def: internal
