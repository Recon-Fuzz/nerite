...
```
┌─ [0] 🏗️ CONSTRUCTOR: ARBPriceFeed.constructor(address,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    🏗️  Contract: ARBPriceFeed
  ├─ [1] ⚙️ FUNCTION: ARBPriceFeed._fetchPricePrimary() (NodeID: 1)
  │   💬 Args: [no args]
  │   👁️  Def: internal
  ...
  └─ [1] 🏗️ CONSTRUCTOR: TokenPriceFeedBase.constructor(address,address,uint256) (NodeID: 7)
      💬 Args: [_owner, _arbUsdOracleAddress, _arbUsdStalenessThreshold]
