...
- **Kind**: internal
- **Source**: 469:423:260
- **Link**: `src/PriceFeeds/ARBPriceFeed.sol:ARBPriceFeed:fetchPrice()`
...
```
┌─ [0] ⚙️ FUNCTION: ARBPriceFeed.fetchRedemptionPrice() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ARBPriceFeed.fetchPrice() (NodeID: 1)
      💬 Args: [no args]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: ARBPriceFeed._fetchPricePrimary() (NodeID: 2)
        💬 Args: [no args]
        👁️  Def: internal
