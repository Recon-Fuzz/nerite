...
┌─ [0] ⚙️ FUNCTION: BorrowerOperations.adjustTrove(uint256,uint256,bool,uint256,bool,uint256) (NodeID: 0)
  ...
  └─ [1] ⚙️ FUNCTION: BorrowerOperations._adjustTrove(contract ITroveManager,uint256,struct TroveChange,uint256) (NodeID: 3)
    ...
    │     💬 Args: [_price]
    │     👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: LiquityBase.getEntireSystemColl() (NodeID: 8)
    │   │   💬 Args: [no args]
    │   │   👁️  Def: public
    │   ├─ [4] ⚙️ FUNCTION: LiquityBase.getEntireSystemDebt() (NodeID: 9)
    │   │   💬 Args: [no args]
    │   │   👁️  Def: public
    ...
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BorrowerOperations._requireValidAdjustmentInCurrentMode(struct TroveChange,struct BorrowerOperations.LocalVariables_adjustTrove) (NodeID: 22)
    │   💬 Args: [_troveChange, vars]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: BorrowerOperations._requireICRisAboveMCR(uint256) (NodeID: 23)
    │ │   💬 Args: [_vars.newICR]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: BorrowerOperations._getNewTCRFromTroveChange(struct TroveChange,uint256) (NodeID: 24)
    │ │   💬 Args: [_troveChange, _vars.price]
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: LiquityBase.getEntireSystemColl() (NodeID: 25)
    │ │ │   💬 Args: [no args]
    │ │ │   👁️  Def: public
    │ │ ├─ [4] ⚙️ FUNCTION: LiquityBase.getEntireSystemDebt() (NodeID: 26)
    │ │ │   💬 Args: [no args]
    │ │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: LiquityMath._computeCR(uint256,uint256,uint256) (NodeID: 27)
    │ │     💬 Args: [totalColl, totalDebt, _price]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: BorrowerOperations._requireNoBorrowingUnlessNewTCRisAboveCCR(uint256,uint256) (NodeID: 28)
    │ │   💬 Args: [_troveChange.debtIncrease, newTCR]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: BorrowerOperations._requireDebtRepaymentGeCollWithdrawal(struct TroveChange,uint256) (NodeID: 29)
    │ │   💬 Args: [_troveChange, _vars.price]
    │ │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: BorrowerOperations._requireNewTCRisAboveCCR(uint256) (NodeID: 30)
    │     💬 Args: [newTCR]
    │     👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: BorrowerOperations._moveTokensFromAdjustment(address,struct TroveChange,contract IBoldToken,contract IActivePool) (NodeID: 31)
        💬 Args: [receiver, _troveChange, vars.boldToken, vars.activePool]
        👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: BorrowerOperations._pullCollAndSendToActivePool(contract IActivePool,uint256) (NodeID: 32)
