...
- **Type**: Interface
- **Path**: lib/openzeppelin-contracts/contracts/access/IAccessControlEnumerable.sol
- **Documentation**:  @dev External interface of AccessControlEnumerable declared to support ERC165 detection.
