...
- **Name**: IPoolMemberNFT
- **Type**: Interface
- **Path**: lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/interfaces/agreements/gdav1/IPoolMemberNFT.sol
...
### initialize(string,string) (inherited from IPoolNFTBase)
...
### triggerMetadataUpdate(uint256) (inherited from IPoolNFTBase)
...
### getTokenId(address,address) (inherited from IPoolNFTBase)
