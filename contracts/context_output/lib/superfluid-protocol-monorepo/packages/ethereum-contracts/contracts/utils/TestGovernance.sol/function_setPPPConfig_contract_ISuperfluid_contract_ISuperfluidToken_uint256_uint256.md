# Function: setPPPConfig(contract ISuperfluid,contract ISuperfluidToken,uint256,uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidGovernanceBase.setPPPConfig(contract ISuperfluid,contract ISuperfluidToken,uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
