# Function: registerAgreementClass(contract ISuperfluid,address)
...
- **ISuperfluid::registerAgreementClass(contract ISuperAgreement)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidGovernanceBase.registerAgreementClass(contract ISuperfluid,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
