# Function: setConfig(contract ISuperfluid,contract ISuperfluidToken,bytes32,uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidGovernanceBase.setConfig(contract ISuperfluid,contract ISuperfluidToken,bytes32,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
