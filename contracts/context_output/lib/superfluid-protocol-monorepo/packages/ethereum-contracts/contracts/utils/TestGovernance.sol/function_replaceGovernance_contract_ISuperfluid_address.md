# Function: replaceGovernance(contract ISuperfluid,address)
...
- **ISuperfluid::replaceGovernance(contract ISuperfluidGovernance)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidGovernanceBase.replaceGovernance(contract ISuperfluid,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
