# Function: enableTrustedForwarder(contract ISuperfluid,contract ISuperfluidToken,address)
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidGovernanceBase.enableTrustedForwarder(contract ISuperfluid,contract ISuperfluidToken,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
