# Function: batchChangeSuperTokenAdmin(contract ISuperfluid,contract ISuperToken[],address[])
...
- **ISuperfluid::changeSuperTokenAdmin(contract ISuperToken,address)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidGovernanceBase.batchChangeSuperTokenAdmin(contract ISuperfluid,contract ISuperToken[],address[]) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
