...
- **Kind**: internal
- **Source**: 5579:76:181
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/utils/SuperfluidFrameworkDeploymentSteps.t.sol:SuperfluidFrameworkDeploymentSteps:getNumSteps()`
...
- **Kind**: internal
- **Source**: 5661:8777:181
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/utils/SuperfluidFrameworkDeploymentSteps.t.sol:SuperfluidFrameworkDeploymentSteps:executeStep(uint8)`
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidFrameworkDeployer.deployTestFramework() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: SuperfluidFrameworkDeploymentSteps.getNumSteps() (NodeID: 1)
  │   💬 Args: [no args]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: SuperfluidFrameworkDeploymentSteps.executeStep(uint8) (NodeID: 2)
      💬 Args: [uint8(i)]
      👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: SuperfluidGovDeployerLibrary.deployTestGovernance() (NodeID: 3)
    │   💬 Args: [no args]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidGovDeployerLibrary.transferOwnership(contract TestGovernance,address) (NodeID: 4)
    │   💬 Args: [testGovernance, address(this)]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidHostDeployerLibrary.deploy(bool,bool,uint64,address,address) (NodeID: 5)
    │   💬 Args: [true, false, 3_000_000, address(simpleForwarder), address(erc2771Forwarder)]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidCFAv1DeployerLibrary.deploy(contract ISuperfluid) (NodeID: 6)
    │   💬 Args: [host]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidIDAv1DeployerLibrary.deploy(contract ISuperfluid) (NodeID: 7)
    │   💬 Args: [host]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidPoolLogicDeployerLibrary.deploy(contract GeneralDistributionAgreementV1) (NodeID: 8)
    │   💬 Args: [GeneralDistributionAgreementV1(address(0))]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: ProxyDeployerLibrary.deploySuperfluidUpgradeableBeacon(address) (NodeID: 9)
    │   💬 Args: [address(superfluidPoolLogic)]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidGDAv1DeployerLibrary.deploy(contract ISuperfluid,contract SuperfluidUpgradeableBeacon) (NodeID: 10)
    │   💬 Args: [host, superfluidPoolBeacon]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidPoolLogicDeployerLibrary.deploy(contract GeneralDistributionAgreementV1) (NodeID: 11)
    │   💬 Args: [gdaV1]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: ProxyDeployerLibrary.deployUUPSProxy() (NodeID: 12)
    │   💬 Args: [no args]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidPoolNFTLogicDeployerLibrary.deployPoolAdminNFT(contract ISuperfluid,contract IGeneralDistributionAgreementV1) (NodeID: 13)
    │   💬 Args: [host, gdaV1]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: ProxyDeployerLibrary.deployUUPSProxy() (NodeID: 14)
    │   💬 Args: [no args]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidPoolNFTLogicDeployerLibrary.deployPoolMemberNFT(contract ISuperfluid,contract IGeneralDistributionAgreementV1) (NodeID: 15)
    │   💬 Args: [host, gdaV1]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: CFAv1ForwarderDeployerLibrary.deploy(contract ISuperfluid) (NodeID: 16)
    │   💬 Args: [host]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: GDAv1ForwarderDeployerLibrary.deploy(contract ISuperfluid) (NodeID: 17)
    │   💬 Args: [host]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperTokenDeployerLibrary.deploy(contract ISuperfluid,contract IPoolAdminNFT,contract IPoolMemberNFT) (NodeID: 18)
    │   💬 Args: [host, poolAdminNFT, poolMemberNFT]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperTokenFactoryDeployerLibrary.deploy(contract ISuperfluid,contract ISuperToken,contract IPoolAdminNFT,contract IPoolMemberNFT) (NodeID: 19)
    │   💬 Args: [host, superTokenLogic, IPoolAdminNFT(poolAdminNFT.getCodeAddress()), IPoolMemberNFT(poolMemberNFT.getCodeAddress())]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidPeripheryDeployerLibrary.deployTestResolver(address) (NodeID: 20)
    │   💬 Args: [address(this)]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidPeripheryDeployerLibrary.deploySuperfluidLoader(contract IResolver) (NodeID: 21)
    │   💬 Args: [testResolver]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidPeripheryDeployerLibrary.deployBatchLiquidator(contract ISuperfluid) (NodeID: 22)
    │   💬 Args: [host]
    │   👁️  Def: external
    ├─ [2] ⚙️ FUNCTION: SuperfluidFrameworkDeploymentSteps._is1820Deployed() (NodeID: 23)
    │   💬 Args: [no args]
    │   👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: SuperfluidPeripheryDeployerLibrary.deployTOGA(contract ISuperfluid,uint256) (NodeID: 24)
