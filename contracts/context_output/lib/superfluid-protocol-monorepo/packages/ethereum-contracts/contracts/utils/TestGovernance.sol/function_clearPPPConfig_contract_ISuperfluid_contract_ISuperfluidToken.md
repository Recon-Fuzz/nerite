# Function: clearPPPConfig(contract ISuperfluid,contract ISuperfluidToken)
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidGovernanceBase.clearPPPConfig(contract ISuperfluid,contract ISuperfluidToken) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
