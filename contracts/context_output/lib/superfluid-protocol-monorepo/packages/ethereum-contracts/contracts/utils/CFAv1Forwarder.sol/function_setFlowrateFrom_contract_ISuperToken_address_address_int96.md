# Function: setFlowrateFrom(contract ISuperToken,address,address,int96)
...
```
┌─ [0] ⚙️ FUNCTION: CFAv1Forwarder.setFlowrateFrom(contract ISuperToken,address,address,int96) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: CFAv1Forwarder._setFlowrateFrom(contract ISuperToken,address,address,int96) (NodeID: 1)
      💬 Args: [token, sender, receiver, flowrate]
      👁️  Def: internal
