# Function: revokePermissions(contract ISuperToken,address)
...
```
┌─ [0] ⚙️ FUNCTION: CFAv1Forwarder.revokePermissions(contract ISuperToken,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: CFAv1Forwarder._updateFlowOperatorPermissions(contract ISuperToken,address,uint8,int96) (NodeID: 1)
      💬 Args: [token, flowOperator, 0, 0]
      👁️  Def: internal
