# Function: clearConfig(contract ISuperfluid,contract ISuperfluidToken,bytes32)
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidGovernanceBase.clearConfig(contract ISuperfluid,contract ISuperfluidToken,bytes32) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: SuperfluidGovernanceBase._clearConfig(contract ISuperfluid,contract ISuperfluidToken,bytes32) (NodeID: 1)
      💬 Args: [host, superToken, key]
      👁️  Def: internal
