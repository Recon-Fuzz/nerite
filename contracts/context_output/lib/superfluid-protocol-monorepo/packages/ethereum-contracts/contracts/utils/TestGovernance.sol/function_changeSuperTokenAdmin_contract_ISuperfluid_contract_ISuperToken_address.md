# Function: changeSuperTokenAdmin(contract ISuperfluid,contract ISuperToken,address)
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidGovernanceBase.changeSuperTokenAdmin(contract ISuperfluid,contract ISuperToken,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
