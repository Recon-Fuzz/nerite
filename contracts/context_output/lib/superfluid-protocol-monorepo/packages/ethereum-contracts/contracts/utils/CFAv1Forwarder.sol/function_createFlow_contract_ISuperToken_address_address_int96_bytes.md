# Function: createFlow(contract ISuperToken,address,address,int96,bytes)
...
```
┌─ [0] ⚙️ FUNCTION: CFAv1Forwarder.createFlow(contract ISuperToken,address,address,int96,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: CFAv1Forwarder._createFlow(contract ISuperToken,address,address,int96,bytes) (NodeID: 1)
