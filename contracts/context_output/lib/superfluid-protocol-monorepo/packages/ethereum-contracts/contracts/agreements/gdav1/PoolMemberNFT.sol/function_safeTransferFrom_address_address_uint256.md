...
┌─ [0] ⚙️ FUNCTION: PoolNFTBase.safeTransferFrom(address,address,uint256) (NodeID: 0)
  ...
  └─ [1] ⚙️ FUNCTION: PoolNFTBase.safeTransferFrom(address,address,uint256,bytes) (NodeID: 1)
    ...
    │ │   💬 Args: [tokenId]
    │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: PoolMemberNFT._ownerOf(uint256) (NodeID: 4)
    │ │     💬 Args: [tokenId]
    │ │     👁️  Def: internal
    ...
    │ │       💬 Args: [tokenId]
    │ │       👁️  Def: internal
    │ │     └─ [6] ⚙️ FUNCTION: PoolMemberNFT._ownerOf(uint256) (NodeID: 8)
    │ │         💬 Args: [tokenId]
    │ │         👁️  Def: internal
    ...
    └─ [2] ⚙️ FUNCTION: PoolNFTBase._safeTransfer(address,address,uint256,bytes) (NodeID: 10)
        ...
        👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: PoolMemberNFT._transfer(address,address,uint256) (NodeID: 11)
          💬 Args: [from, to, tokenId]
          👁️  Def: internal
```
