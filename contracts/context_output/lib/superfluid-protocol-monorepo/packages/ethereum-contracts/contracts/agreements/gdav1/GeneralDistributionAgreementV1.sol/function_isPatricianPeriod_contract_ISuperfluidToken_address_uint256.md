...
```
┌─ [0] ⚙️ FUNCTION: GeneralDistributionAgreementV1.isPatricianPeriod(contract ISuperfluidToken,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     💬 Args: [pppConfig]
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: SolvencyHelperLibrary.isPatricianPeriod(int256,int256,uint256,uint256) (NodeID: 3)
      💬 Args: [availableBalance, _getUIndexData(abi.encode(token), account).totalBuffer.toInt256(), liquidationPeriod, patricianPeriod]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: GeneralDistributionAgreementV1._getUIndexData(bytes,address) (NodeID: 4)
