# Function: updateIndex(contract ISuperfluidToken,uint32,uint128,bytes)
...
```
┌─ [0] ⚙️ FUNCTION: InstantDistributionAgreementV1.updateIndex(contract ISuperfluidToken,uint32,uint128,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │     💬 Args: [token, iId]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: InstantDistributionAgreementV1._updateIndex(contract ISuperfluidToken,address,uint32,bytes32,struct InstantDistributionAgreementV1.IndexData,uint128,bytes) (NodeID: 5)
      💬 Args: [token, publisher, indexId, iId, idata, indexValue, context.userData]
      👁️  Def: private
    ├─ [2] ⚙️ FUNCTION: InstantDistributionAgreementV1._adjustPublisherDeposit(contract ISuperfluidToken,address,int256) (NodeID: 6)
    ...
    │     💬 Args: [uint256(data[0])]
    │     👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: InstantDistributionAgreementV1._encodeIndexData(struct InstantDistributionAgreementV1.IndexData) (NodeID: 8)
        💬 Args: [idata]
        👁️  Def: private
```
