# Function: increaseFlowRateAllowance(contract ISuperfluidToken,address,int96,bytes)
...
- **Kind**: internal
- **Source**: 28513:1114:121
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/agreements/ConstantFlowAgreementV1.sol:ConstantFlowAgreementV1:increaseFlowRateAllowanceWithPermissions(contract ISuperfluidToken,address,uint8,int96,bytes)`
...
function increaseFlowRateAllowanceWithPermissions(ISuperfluidToken token, address flowOperator, uint8 permissionsToAdd, int96 addedFlowRateAllowance, bytes calldata ctx) override public returns (bytes memory newCtx) {
    newCtx = ctx;
    ISuperfluid.Context memory currentContext = _validateAndAuthorizeUpdateFlowOperatorDataInput(token, flowOperator, permissionsToAdd, addedFlowRateAllowance, ctx);
...
- **Kind**: internal
- **Source**: 30960:191:121
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/agreements/ConstantFlowAgreementV1.sol:ConstantFlowAgreementV1:addPermissions(uint8,uint8)`
...
```
┌─ [0] ⚙️ FUNCTION: ConstantFlowAgreementV1.increaseFlowRateAllowance(contract ISuperfluidToken,address,int96,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: ConstantFlowAgreementV1.increaseFlowRateAllowanceWithPermissions(contract ISuperfluidToken,address,uint8,int96,bytes) (NodeID: 1)
      💬 Args: [token, flowOperator, 0, addedFlowRateAllowance, ctx]
      👁️  Def: public
    ...
    │   💬 Args: [token, flowOperator, permissionsToAdd, addedFlowRateAllowance, ctx]
    │   👁️  Def: internal
    ...
    │     💬 Args: [token, ctx]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1.getFlowOperatorData(contract ISuperfluidToken,address,address) (NodeID: 5)
    │   💬 Args: [token, currentContext.msgSender, flowOperator]
    │   👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._generateFlowOperatorId(address,address) (NodeID: 6)
    │ │   💬 Args: [sender, flowOperator]
    │ │   👁️  Def: private
    │ └─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._getFlowOperatorData(contract ISuperfluidToken,bytes32) (NodeID: 7)
    │     💬 Args: [token, flowOperatorId]
    │     👁️  Def: private
    │   └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowOperatorData(uint256) (NodeID: 8)
    │       💬 Args: [uint256(data[0])]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1.addPermissions(uint8,uint8) (NodeID: 9)
    │   💬 Args: [oldPermissions, permissionsToAdd]
    │   👁️  Def: public
    └─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateFlowOperatorData(contract ISuperfluidToken,bytes32,uint8,int96) (NodeID: 10)
        💬 Args: [token, flowOperatorId, permissions, newFlowRateAllowance]
        👁️  Def: private
      └─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowOperatorData(struct ConstantFlowAgreementV1.FlowOperatorData) (NodeID: 11)
