# Function: updateFlowOperatorPermissions(contract ISuperfluidToken,address,uint8,int96,bytes)
...
```
┌─ [0] ⚙️ FUNCTION: ConstantFlowAgreementV1.updateFlowOperatorPermissions(contract ISuperfluidToken,address,uint8,int96,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     💬 Args: [token, ctx]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ConstantFlowAgreementV1._generateFlowOperatorId(address,address) (NodeID: 4)
  │   💬 Args: [currentContext.msgSender, flowOperator]
  │   👁️  Def: private
  └─ [1] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowOperatorData(struct ConstantFlowAgreementV1.FlowOperatorData) (NodeID: 5)
