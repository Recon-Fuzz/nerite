# Function: decreaseFlowRateAllowance(contract ISuperfluidToken,address,int96,bytes)
...
- **Kind**: internal
- **Source**: 29727:1227:121
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/agreements/ConstantFlowAgreementV1.sol:ConstantFlowAgreementV1:decreaseFlowRateAllowanceWithPermissions(contract ISuperfluidToken,address,uint8,int96,bytes)`
...
```
┌─ [0] ⚙️ FUNCTION: ConstantFlowAgreementV1.decreaseFlowRateAllowance(contract ISuperfluidToken,address,int96,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: ConstantFlowAgreementV1.decreaseFlowRateAllowanceWithPermissions(contract ISuperfluidToken,address,uint8,int96,bytes) (NodeID: 1)
      💬 Args: [token, flowOperator, 0, subtractedFlowRateAllowance, ctx]
      👁️  Def: public
    ...
    │       💬 Args: [uint256(data[0])]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1.removePermissions(uint8,uint8) (NodeID: 9)
