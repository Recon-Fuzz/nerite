...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidPool.getTotalConnectedFlowRate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: SuperfluidPool._getTotalFlowRate() (NodeID: 15)
      💬 Args: [no args]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 16)
    │   💬 Args: [uint256(_index.totalUnits)]
    │   👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: SafeCast.toInt96(int256) (NodeID: 17)
