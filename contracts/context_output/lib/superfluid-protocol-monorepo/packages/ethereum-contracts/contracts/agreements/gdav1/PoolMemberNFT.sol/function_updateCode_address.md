...
- **Kind**: internal
- **Source**: 1399:162:125
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/agreements/gdav1/PoolMemberNFT.sol:PoolMemberNFT:proxiableUUID()`
...
┌─ [0] ⚙️ FUNCTION: PoolNFTBase.updateCode(address) (NodeID: 0)
  ...
  └─ [1] ⚙️ FUNCTION: UUPSProxiable._updateCodeAddress(address) (NodeID: 1)
    ...
    │   💬 Args: [no args]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: PoolMemberNFT.proxiableUUID() (NodeID: 3)
    │   💬 Args: [no args]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: UUPSUtils.setImplementation(address) (NodeID: 4)
    │   💬 Args: [newAddress]
    │   👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: PoolMemberNFT.proxiableUUID() (NodeID: 5)
        💬 Args: [no args]
        👁️  Def: public
```
