# Function: isPatricianPeriod(contract ISuperfluidToken,address,uint256)
...
```
┌─ [0] ⚙️ FUNCTION: ConstantFlowAgreementV1.isPatricianPeriod(contract ISuperfluidToken,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     💬 Args: [pppConfig]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 3)
  │   💬 Args: [token, account]
  │   👁️  Def: private
  ...
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: SolvencyHelperLibrary.isPatricianPeriod(int256,int256,uint256,uint256) (NodeID: 6)
