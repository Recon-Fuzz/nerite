# Function: deleteFlowByOperator(contract ISuperfluidToken,address,address,bytes)
...
```
┌─ [0] ⚙️ FUNCTION: ConstantFlowAgreementV1.deleteFlowByOperator(contract ISuperfluidToken,address,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
