# Function: approveSubscription(contract ISuperfluidToken,address,uint32,bytes)
...
function approveSubscription(ISuperfluidToken token, address publisher, uint32 indexId, bytes calldata ctx) override external returns (bytes memory newCtx) {
    ...
    if (!vars.subscriptionExists) {
        ...
        vars.sdata = SubscriptionData({publisher: publisher, indexId: indexId, subId: 0, units: 0, indexValue: vars.idata.indexValue});
        ...
        vars.cbdata = AgreementLibrary.callAppBeforeCallback(cbStates, newCtx);
        int balanceDelta = int256(uint256(vars.idata.indexValue - vars.sdata.indexValue)) * int256(uint256(vars.sdata.units));
...
### _findAndFillSubsBitmap(contract ISuperfluidToken,address,bytes32)

- **Kind**: internal
- **Source**: 39694:399:122
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/agreements/InstantDistributionAgreementV1.sol:InstantDistributionAgreementV1:_findAndFillSubsBitmap(contract ISuperfluidToken,address,bytes32)`

```solidity
function _findAndFillSubsBitmap(ISuperfluidToken token, address subscriber, bytes32 iId) private returns (uint32 subId) {
    return SlotsBitmapLibrary.findEmptySlotAndFill(token, subscriber, _SUBSCRIBER_SUBS_BITMAP_STATE_SLOT_ID, _SUBSCRIBER_SUB_DATA_STATE_SLOT_ID_START, iId);
}
```
...
```
┌─ [0] ⚙️ FUNCTION: InstantDistributionAgreementV1.approveSubscription(contract ISuperfluidToken,address,uint32,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │     💬 Args: [ctx, 0]
  │     👁️  Def: private
  ├─ [1] ⚙️ FUNCTION: InstantDistributionAgreementV1._findAndFillSubsBitmap(contract ISuperfluidToken,address,bytes32) (NodeID: 12)
  │   💬 Args: [token, subscriber, vars.iId]
  │   👁️  Def: private
  │ └─ [2] ⚙️ FUNCTION: SlotsBitmapLibrary.findEmptySlotAndFill(contract ISuperfluidToken,address,uint256,uint256,bytes32) (NodeID: 13)
  │     💬 Args: [token, subscriber, _SUBSCRIBER_SUBS_BITMAP_STATE_SLOT_ID, _SUBSCRIBER_SUB_DATA_STATE_SLOT_ID_START, iId]
  │     👁️  Def: public
  ...
  │     👁️  Def: private
  ├─ [1] ⚙️ FUNCTION: AgreementLibrary.callAppBeforeCallback(struct AgreementLibrary.CallbackInputs,bytes) (NodeID: 23)
  │   💬 Args: [cbStates, newCtx]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: AgreementLibrary._pushCallbackStack(bytes,struct AgreementLibrary.CallbackInputs) (NodeID: 24)
  │ │   💬 Args: [ctx, inputs]
  │ │   👁️  Def: private
  │ ├─ [2] ⚙️ FUNCTION: AgreementLibrary._selectorFromNoopBit(uint256) (NodeID: 25)
  │ │   💬 Args: [inputs.noopBit]
  │ │   👁️  Def: private
  │ └─ [2] ⚙️ FUNCTION: AgreementLibrary._popCallbackStack(bytes,int256) (NodeID: 26)
  │     💬 Args: [ctx, 0]
  │     👁️  Def: private
  ├─ [1] ⚙️ FUNCTION: InstantDistributionAgreementV1._encodeIndexData(struct InstantDistributionAgreementV1.IndexData) (NodeID: 27)
  │   💬 Args: [vars.idata]
  │   👁️  Def: private
  ├─ [1] ⚙️ FUNCTION: InstantDistributionAgreementV1._adjustPublisherDeposit(contract ISuperfluidToken,address,int256) (NodeID: 28)
  │   💬 Args: [token, publisher, -balanceDelta]
  │   👁️  Def: private
  │ └─ [2] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 29)
  │     💬 Args: [uint256(data[0])]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: InstantDistributionAgreementV1._findAndFillSubsBitmap(contract ISuperfluidToken,address,bytes32) (NodeID: 30)
  │   💬 Args: [token, subscriber, vars.iId]
  │   👁️  Def: private
  │ └─ [2] ⚙️ FUNCTION: SlotsBitmapLibrary.findEmptySlotAndFill(contract ISuperfluidToken,address,uint256,uint256,bytes32) (NodeID: 31)
  │     💬 Args: [token, subscriber, _SUBSCRIBER_SUBS_BITMAP_STATE_SLOT_ID, _SUBSCRIBER_SUB_DATA_STATE_SLOT_ID_START, iId]
  │     👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: InstantDistributionAgreementV1._encodeSubscriptionData(struct InstantDistributionAgreementV1.SubscriptionData) (NodeID: 32)
  │   💬 Args: [vars.sdata]
  │   👁️  Def: private
