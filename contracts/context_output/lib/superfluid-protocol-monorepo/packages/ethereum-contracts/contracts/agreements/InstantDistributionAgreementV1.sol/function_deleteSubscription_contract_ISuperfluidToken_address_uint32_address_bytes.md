# Function: deleteSubscription(contract ISuperfluidToken,address,uint32,address,bytes)
...
```
┌─ [0] ⚙️ FUNCTION: InstantDistributionAgreementV1.deleteSubscription(contract ISuperfluidToken,address,uint32,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │     👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: InstantDistributionAgreementV1._adjustPublisherDeposit(contract ISuperfluidToken,address,int256) (NodeID: 15)
  │   💬 Args: [token, publisher, -balanceDelta]
  │   👁️  Def: private
  │ └─ [2] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 16)
  │     💬 Args: [uint256(data[0])]
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: AgreementLibrary.callAppAfterCallback(struct AgreementLibrary.CallbackInputs,bytes,bytes) (NodeID: 17)
      💬 Args: [cbStates, vars.cbdata, newCtx]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: AgreementLibrary._pushCallbackStack(bytes,struct AgreementLibrary.CallbackInputs) (NodeID: 18)
    │   💬 Args: [newCtx, inputs]
    │   👁️  Def: private
    ├─ [2] ⚙️ FUNCTION: AgreementLibrary._selectorFromNoopBit(uint256) (NodeID: 19)
    │   💬 Args: [inputs.noopBit]
    │   👁️  Def: private
    ├─ [2] ⚙️ FUNCTION: AgreementLibrary._adjustNewAppCreditUsed(uint256,int256) (NodeID: 20)
    │   💬 Args: [inputs.appCreditGranted, appContext.appCreditUsed]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: AgreementLibrary.max(int256,int256) (NodeID: 21)
    │     💬 Args: [0, min(appCreditGranted.toInt256(), appCallbackDepositDelta)]
    │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: AgreementLibrary.min(int256,int256) (NodeID: 22)
    ...
    │         👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: AgreementLibrary._popCallbackStack(bytes,int256) (NodeID: 24)
