# Function: getFlow(contract ISuperfluidToken,address,contract ISuperfluidPool)
...
```
┌─ [0] ⚙️ FUNCTION: GeneralDistributionAgreementV1.getFlow(contract ISuperfluidToken,address,contract ISuperfluidPool) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
