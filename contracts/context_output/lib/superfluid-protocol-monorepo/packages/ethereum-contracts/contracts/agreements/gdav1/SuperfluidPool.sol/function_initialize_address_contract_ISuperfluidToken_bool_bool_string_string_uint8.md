# Function: initialize(address,contract ISuperfluidToken,bool,bool,string,string,uint8)
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidPool.initialize(address,contract ISuperfluidToken,bool,bool,string,string,uint8) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
