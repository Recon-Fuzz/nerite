# Function: createFlowByOperator(contract ISuperfluidToken,address,address,int96,bytes)
...
function createFlowByOperator(ISuperfluidToken token, address sender, address receiver, int96 flowRate, bytes calldata ctx) override external returns (bytes memory newCtx) {
    ...
    if (currentContext.msgSender == sender) revert CFA_ACL_NO_SENDER_CREATE();
    {
        ...
        int96 updatedFlowRateAllowance = (flowRateAllowance == type(int96).max) ? flowRateAllowance : (flowRateAllowance - flowRate);
...
### _createFlow(struct ConstantFlowAgreementV1._StackVars_createOrUpdateFlow,bytes,struct ISuperfluid.Context)

- **Kind**: internal
- **Source**: 14305:1005:121
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/agreements/ConstantFlowAgreementV1.sol:ConstantFlowAgreementV1:_createFlow(struct ConstantFlowAgreementV1._StackVars_createOrUpdateFlow,bytes,struct ISuperfluid.Context)`

```solidity
function _createFlow(_StackVars_createOrUpdateFlow memory flowVars, bytes calldata ctx, ISuperfluid.Context memory currentContext) internal returns (bytes memory newCtx) {
    ...
    if (ISuperfluid(msg.sender).isApp(ISuperApp(flowVars.receiver))) {
        newCtx = _changeFlowToApp(flowVars.receiver, flowVars.token, flowParams, oldFlowData, ctx, currentContext, FlowChangeType.CREATE_FLOW);
    } else {
...
```
┌─ [0] ⚙️ FUNCTION: ConstantFlowAgreementV1.createFlowByOperator(contract ISuperfluidToken,address,address,int96,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │   💬 Args: [permissions, FlowChangeType.CREATE_FLOW]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateFlowOperatorData(contract ISuperfluidToken,bytes32,uint8,int96) (NodeID: 7)
  │   💬 Args: [token, flowOperatorId, permissions, updatedFlowRateAllowance]
  │   👁️  Def: private
  │ └─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowOperatorData(struct ConstantFlowAgreementV1.FlowOperatorData) (NodeID: 8)
  │     💬 Args: [flowOperatorData]
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: ConstantFlowAgreementV1._createFlow(struct ConstantFlowAgreementV1._StackVars_createOrUpdateFlow,bytes,struct ISuperfluid.Context) (NodeID: 9)
      💬 Args: [flowVars, ctx, currentContext]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1._createOrUpdateFlowCheck(struct ConstantFlowAgreementV1._StackVars_createOrUpdateFlow,struct ISuperfluid.Context) (NodeID: 10)
    │   💬 Args: [flowVars, currentContext]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._generateFlowId(address,address) (NodeID: 11)
    │     💬 Args: [flowVars.sender, flowVars.receiver]
    │     👁️  Def: private
    ├─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAgreementData(contract ISuperfluidToken,bytes32) (NodeID: 12)
    │   💬 Args: [flowVars.token, flowId]
    │   👁️  Def: private
    │ └─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 13)
    │     💬 Args: [uint256(data[0])]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1._changeFlowToApp(address,contract ISuperfluidToken,struct ConstantFlowAgreementV1.FlowParams,struct ConstantFlowAgreementV1.FlowData,bytes,struct ISuperfluid.Context,enum ConstantFlowAgreementV1.FlowChangeType) (NodeID: 14)
    │   💬 Args: [flowVars.receiver, flowVars.token, flowParams, oldFlowData, ctx, currentContext, FlowChangeType.CREATE_FLOW]
    │   👁️  Def: private
    │ ├─ [3] ⚙️ FUNCTION: AgreementLibrary.createCallbackInputs(contract ISuperfluidToken,address,bytes32,bytes) (NodeID: 15)
    │ │   💬 Args: [token, appToCallback, flowParams.flowId, abi.encode(flowParams.sender, flowParams.receiver)]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: AgreementLibrary.callAppBeforeCallback(struct AgreementLibrary.CallbackInputs,bytes) (NodeID: 16)
    │ │   💬 Args: [cbStates, ctx]
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: AgreementLibrary._pushCallbackStack(bytes,struct AgreementLibrary.CallbackInputs) (NodeID: 17)
    │ │ │   💬 Args: [ctx, inputs]
    │ │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: AgreementLibrary._selectorFromNoopBit(uint256) (NodeID: 18)
    │ │ │   💬 Args: [inputs.noopBit]
    │ │ │   👁️  Def: private
    │ │ └─ [4] ⚙️ FUNCTION: AgreementLibrary._popCallbackStack(bytes,int256) (NodeID: 19)
    │ │     💬 Args: [ctx, 0]
    │ │     👁️  Def: private
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._changeFlow(uint256,contract ISuperfluidToken,contract ISuperfluidToken,struct ConstantFlowAgreementV1.FlowParams,struct ConstantFlowAgreementV1.FlowData) (NodeID: 20)
    │ │   💬 Args: [currentContext.timestamp, currentContext.appCreditToken, token, flowParams, oldFlowData]
    │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: SolvencyHelperLibrary.decode3PsData(contract ISuperfluid,contract ISuperfluidToken) (NodeID: 21)
    │ │ │   💬 Args: [ISuperfluid(_host), token]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: SuperfluidGovernanceConfigs.decodePPPConfig(uint256) (NodeID: 22)
    │ │ │     💬 Args: [pppConfig]
    │ │ │     👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._calculateDeposit(int96,uint256) (NodeID: 23)
    │ │ │   💬 Args: [flowParams.flowRate, liquidationPeriod]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._clipDepositNumberRoundingUp(uint256) (NodeID: 24)
    │ │ │     💬 Args: [deposit]
    │ │ │     👁️  Def: internal
    ...
    │ │ │   💬 Args: [oldFlowData.deposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 29)
    ...
    │ │ │   💬 Args: [minimumDeposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 33)
    │ │ │   💬 Args: [newFlowData]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 34)
    │ │ │   💬 Args: [token, flowParams.sender, oldFlowData.flowRate - flowParams.flowRate, depositDelta, 0, currentTimestamp]
    │ │ │   👁️  Def: private
    │ │ │ ├─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 35)
    │ │ │ │   💬 Args: [token, account]
    │ │ │ │   👁️  Def: private
    │ │ │ │ └─ [6] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 36)
    │ │ │ │     💬 Args: [uint256(data[0])]
    │ │ │ │     👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 37)
    │ │ │ │   💬 Args: [(currentTimestamp - state.timestamp)]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 38)
    │ │ │ │   💬 Args: [state.deposit]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 39)
    │ │ │ │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 40)
    │ │ │ │   💬 Args: [state.owedDeposit]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 41)
    │ │ │ │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │ │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 42)
    │ │ │     💬 Args: [state]
    │ │ │     👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 43)
    │ │     💬 Args: [token, flowParams.receiver, flowParams.flowRate - oldFlowData.flowRate, 0, 0, currentTimestamp]
    │ │     👁️  Def: private
    │ │   ├─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 44)
    │ │   │   💬 Args: [token, account]
    │ │   │   👁️  Def: private
    │ │   │ └─ [6] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 45)
    │ │   │     💬 Args: [uint256(data[0])]
    │ │   │     👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 46)
    │ │   │   💬 Args: [(currentTimestamp - state.timestamp)]
    │ │   │   👁️  Def: internal
    ...
    │ │   │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │ │   │   👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 49)
    │ │   │   💬 Args: [state.owedDeposit]
    │ │   │   👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 50)
    │ │   │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │ │   │   👁️  Def: internal
    │ │   └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 51)
    │ │       💬 Args: [state]
    │ │       👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: AgreementLibrary.max(uint256,uint256) (NodeID: 52)
    │ │   💬 Args: [DEFAULT_MINIMUM_DEPOSIT, minimumDeposit]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 53)
    │ │   💬 Args: [oldFlowData.owedDeposit]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: AgreementLibrary.callAppAfterCallback(struct AgreementLibrary.CallbackInputs,bytes,bytes) (NodeID: 54)
    │ │   💬 Args: [cbStates, vars.cbdata, newCtx]
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: AgreementLibrary._pushCallbackStack(bytes,struct AgreementLibrary.CallbackInputs) (NodeID: 55)
    │ │ │   💬 Args: [newCtx, inputs]
    │ │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: AgreementLibrary._selectorFromNoopBit(uint256) (NodeID: 56)
    │ │ │   💬 Args: [inputs.noopBit]
    │ │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: AgreementLibrary._adjustNewAppCreditUsed(uint256,int256) (NodeID: 57)
    │ │ │   💬 Args: [inputs.appCreditGranted, appContext.appCreditUsed]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: AgreementLibrary.max(int256,int256) (NodeID: 58)
    │ │ │     💬 Args: [0, min(appCreditGranted.toInt256(), appCallbackDepositDelta)]
    │ │ │     👁️  Def: internal
    │ │ │   └─ [6] ⚙️ FUNCTION: AgreementLibrary.min(int256,int256) (NodeID: 59)
    │ │ │       💬 Args: [appCreditGranted.toInt256(), appCallbackDepositDelta]
    │ │ │       👁️  Def: internal
    │ │ │     └─ [7] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 60)
    │ │ │         💬 Args: [appCreditGranted]
    │ │ │         👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: AgreementLibrary._popCallbackStack(bytes,int256) (NodeID: 61)
    │ │     💬 Args: [ctx, appContext.appCreditUsed]
    │ │     👁️  Def: private
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAgreementData(contract ISuperfluidToken,bytes32) (NodeID: 62)
    │ │   💬 Args: [token, flowParams.flowId]
    │ │   👁️  Def: private
    │ │ └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 63)
    │ │     💬 Args: [uint256(data[0])]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._changeFlow(uint256,contract ISuperfluidToken,contract ISuperfluidToken,struct ConstantFlowAgreementV1.FlowParams,struct ConstantFlowAgreementV1.FlowData) (NodeID: 64)
    │ │   💬 Args: [currentContext.timestamp, currentContext.appCreditToken, token, flowParams, oldFlowData]
    │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: SolvencyHelperLibrary.decode3PsData(contract ISuperfluid,contract ISuperfluidToken) (NodeID: 65)
    │ │ │   💬 Args: [ISuperfluid(_host), token]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: SuperfluidGovernanceConfigs.decodePPPConfig(uint256) (NodeID: 66)
    │ │ │     💬 Args: [pppConfig]
    │ │ │     👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._calculateDeposit(int96,uint256) (NodeID: 67)
    │ │ │   💬 Args: [flowParams.flowRate, liquidationPeriod]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._clipDepositNumberRoundingUp(uint256) (NodeID: 68)
    │ │ │     💬 Args: [deposit]
    │ │ │     👁️  Def: internal
    ...
    │ │ │   💬 Args: [oldFlowData.deposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 73)
    │ │ │   💬 Args: [(oldFlowData.deposit.toInt256() + depositDelta)]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 74)
    │ │ │   💬 Args: [oldFlowData.owedDeposit]
    │ │ │   👁️  Def: internal
    ...
    │ │ │   💬 Args: [minimumDeposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 77)
    │ │ │   💬 Args: [newFlowData]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 78)
    │ │ │   💬 Args: [token, flowParams.sender, oldFlowData.flowRate - flowParams.flowRate, depositDelta, 0, currentTimestamp]
    │ │ │   👁️  Def: private
    │ │ │ ├─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 79)
    │ │ │ │   💬 Args: [token, account]
    │ │ │ │   👁️  Def: private
    │ │ │ │ └─ [6] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 80)
    │ │ │ │     💬 Args: [uint256(data[0])]
    │ │ │ │     👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 81)
    │ │ │ │   💬 Args: [(currentTimestamp - state.timestamp)]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 82)
    │ │ │ │   💬 Args: [state.deposit]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 83)
    │ │ │ │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 84)
    │ │ │ │   💬 Args: [state.owedDeposit]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 85)
    │ │ │ │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │ │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 86)
    │ │ │     💬 Args: [state]
    │ │ │     👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 87)
    │ │     💬 Args: [token, flowParams.receiver, flowParams.flowRate - oldFlowData.flowRate, 0, 0, currentTimestamp]
    │ │     👁️  Def: private
    │ │   ├─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 88)
    │ │   │   💬 Args: [token, account]
    │ │   │   👁️  Def: private
    │ │   │ └─ [6] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 89)
    │ │   │     💬 Args: [uint256(data[0])]
    │ │   │     👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 90)
    │ │   │   💬 Args: [(currentTimestamp - state.timestamp)]
    │ │   │   👁️  Def: internal
    ...
    │ │   │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │ │   │   👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 93)
    │ │   │   💬 Args: [state.owedDeposit]
    │ │   │   👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 94)
    │ │   │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │ │   │   👁️  Def: internal
    │ │   └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 95)
    │ │       💬 Args: [state]
    │ │       👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 96)
    │ │   💬 Args: [oldFlowData.owedDeposit]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 97)
    │ │   💬 Args: [vars.newFlowData.deposit]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 98)
    │ │   💬 Args: [(vars.newFlowData.deposit.toInt256() + appCreditDelta)]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 99)
    │ │   💬 Args: [vars.newFlowData.owedDeposit]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 100)
    │ │   💬 Args: [(vars.newFlowData.owedDeposit.toInt256() + appCreditDelta)]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 101)
    │ │   💬 Args: [vars.newFlowData]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 102)
    │ │   💬 Args: [token, flowParams.sender, 0, appCreditDelta, 0, currentContext.timestamp]
    │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 103)
    │ │ │   💬 Args: [token, account]
    │ │ │   👁️  Def: private
    │ │ │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 104)
    │ │ │     💬 Args: [uint256(data[0])]
    │ │ │     👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 105)
    │ │ │   💬 Args: [(currentTimestamp - state.timestamp)]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 106)
    │ │ │   💬 Args: [state.deposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 107)
    │ │ │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 108)
    │ │ │   💬 Args: [state.owedDeposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 109)
    │ │ │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │ │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 110)
    │ │     💬 Args: [state]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 111)
    │ │   💬 Args: [token, flowParams.receiver, 0, 0, appCreditDelta, currentContext.timestamp]
    │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 112)
    │ │ │   💬 Args: [token, account]
    │ │ │   👁️  Def: private
    │ │ │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 113)
    │ │ │     💬 Args: [uint256(data[0])]
    │ │ │     👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 114)
    │ │ │   💬 Args: [(currentTimestamp - state.timestamp)]
    │ │ │   👁️  Def: internal
    ...
    │ │ │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 117)
    │ │ │   💬 Args: [state.owedDeposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 118)
    │ │ │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │ │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 119)
    │ │     💬 Args: [state]
    │ │     👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: AgreementLibrary.min(int256,int256) (NodeID: 120)
    │     💬 Args: [-availableBalance, -appCreditDelta]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1._changeFlowToNonApp(contract ISuperfluidToken,struct ConstantFlowAgreementV1.FlowParams,struct ConstantFlowAgreementV1.FlowData,bytes,struct ISuperfluid.Context) (NodeID: 121)
    │   💬 Args: [flowVars.token, flowParams, oldFlowData, ctx, currentContext]
    │   👁️  Def: private
    │ └─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._changeFlow(uint256,contract ISuperfluidToken,contract ISuperfluidToken,struct ConstantFlowAgreementV1.FlowParams,struct ConstantFlowAgreementV1.FlowData) (NodeID: 122)
    │     💬 Args: [currentContext.timestamp, currentContext.appCreditToken, token, flowParams, oldFlowData]
    │     👁️  Def: private
    │   ├─ [4] ⚙️ FUNCTION: SolvencyHelperLibrary.decode3PsData(contract ISuperfluid,contract ISuperfluidToken) (NodeID: 123)
    │   │   💬 Args: [ISuperfluid(_host), token]
    │   │   👁️  Def: internal
    │   │ └─ [5] ⚙️ FUNCTION: SuperfluidGovernanceConfigs.decodePPPConfig(uint256) (NodeID: 124)
    │   │     💬 Args: [pppConfig]
    │   │     👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._calculateDeposit(int96,uint256) (NodeID: 125)
    │   │   💬 Args: [flowParams.flowRate, liquidationPeriod]
    │   │   👁️  Def: internal
    │   │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._clipDepositNumberRoundingUp(uint256) (NodeID: 126)
    │   │     💬 Args: [deposit]
    │   │     👁️  Def: internal
    ...
    │   │   💬 Args: [oldFlowData.deposit]
    │   │   👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 131)
    │   │   💬 Args: [(oldFlowData.deposit.toInt256() + depositDelta)]
    │   │   👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 132)
    │   │   💬 Args: [oldFlowData.owedDeposit]
    │   │   👁️  Def: internal
    ...
    │   │   💬 Args: [minimumDeposit]
    │   │   👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 135)
    │   │   💬 Args: [newFlowData]
    │   │   👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 136)
    │   │   💬 Args: [token, flowParams.sender, oldFlowData.flowRate - flowParams.flowRate, depositDelta, 0, currentTimestamp]
    │   │   👁️  Def: private
    │   │ ├─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 137)
    │   │ │   💬 Args: [token, account]
    │   │ │   👁️  Def: private
    │   │ │ └─ [6] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 138)
    │   │ │     💬 Args: [uint256(data[0])]
    │   │ │     👁️  Def: internal
    │   │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 139)
    │   │ │   💬 Args: [(currentTimestamp - state.timestamp)]
    │   │ │   👁️  Def: internal
    │   │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 140)
    │   │ │   💬 Args: [state.deposit]
    │   │ │   👁️  Def: internal
    │   │ ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 141)
    │   │ │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │   │ │   👁️  Def: internal
    │   │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 142)
    │   │ │   💬 Args: [state.owedDeposit]
    │   │ │   👁️  Def: internal
    │   │ ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 143)
    │   │ │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │   │ │   👁️  Def: internal
    │   │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 144)
    │   │     💬 Args: [state]
    │   │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 145)
    │       💬 Args: [token, flowParams.receiver, flowParams.flowRate - oldFlowData.flowRate, 0, 0, currentTimestamp]
    │       👁️  Def: private
    │     ├─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 146)
    │     │   💬 Args: [token, account]
    │     │   👁️  Def: private
    │     │ └─ [6] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 147)
    │     │     💬 Args: [uint256(data[0])]
    │     │     👁️  Def: internal
    │     ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 148)
    │     │   💬 Args: [(currentTimestamp - state.timestamp)]
    │     │   👁️  Def: internal
    ...
    │     │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │     │   👁️  Def: internal
    │     ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 151)
    │     │   💬 Args: [state.owedDeposit]
    │     │   👁️  Def: internal
    │     ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 152)
    │     │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │     │   👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 153)
    │         💬 Args: [state]
    │         👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1._requireAvailableBalance(contract ISuperfluidToken,address,struct ISuperfluid.Context) (NodeID: 154)
