# Function: disconnectPool(contract ISuperfluidPool,bytes)
...
- **Kind**: internal
- **Source**: 14421:1670:123
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/agreements/gdav1/GeneralDistributionAgreementV1.sol:GeneralDistributionAgreementV1:connectPool(contract ISuperfluidPool,bool,bytes)`
...
```
┌─ [0] ⚙️ FUNCTION: GeneralDistributionAgreementV1.disconnectPool(contract ISuperfluidPool,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: GeneralDistributionAgreementV1.connectPool(contract ISuperfluidPool,bool,bytes) (NodeID: 1)
      💬 Args: [pool, false, ctx]
      👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: AgreementLibrary.authorizeTokenAccess(contract ISuperfluidToken,bytes) (NodeID: 2)
    │   💬 Args: [token, ctx]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: GeneralDistributionAgreementV1._isMemberConnected(contract ISuperfluidToken,address,address) (NodeID: 3)
    │   💬 Args: [token, address(pool), msgSender]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: GeneralDistributionAgreementV1._getPoolMemberData(contract ISuperfluidToken,address,contract ISuperfluidPool) (NodeID: 4)
    │     💬 Args: [token, member, ISuperfluidPool(pool)]
    │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: GeneralDistributionAgreementV1._decodePoolMemberData(uint256) (NodeID: 5)
    │       💬 Args: [uint256(token.getAgreementData(address(this), _getPoolMemberHash(poolMember, pool), 1)[0])]
    │       👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: GeneralDistributionAgreementV1._getPoolMemberHash(address,contract ISuperfluidPool) (NodeID: 6)
    │         💬 Args: [poolMember, pool]
    │         👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: GeneralDistributionAgreementV1._findAndFillPoolConnectionsBitmap(contract ISuperfluidToken,address,bytes32) (NodeID: 7)
    │   💬 Args: [token, msgSender, bytes32(uint256(uint160(address(pool))))]
    │   👁️  Def: private
    │ └─ [3] ⚙️ FUNCTION: SlotsBitmapLibrary.findEmptySlotAndFill(contract ISuperfluidToken,address,uint256,uint256,bytes32) (NodeID: 8)
    │     💬 Args: [token, poolMember, _POOL_SUBS_BITMAP_STATE_SLOT_ID, _POOL_CONNECTIONS_DATA_STATE_SLOT_ID_START, poolID]
    │     👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: GeneralDistributionAgreementV1._getPoolMemberHash(address,contract ISuperfluidPool) (NodeID: 9)
    │   💬 Args: [msgSender, pool]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: GeneralDistributionAgreementV1._encodePoolMemberData(struct GeneralDistributionAgreementV1.PoolMemberData) (NodeID: 10)
    │   💬 Args: [PoolMemberData({poolID: poolSlotID, pool: address(pool)})]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: GeneralDistributionAgreementV1._getPoolMemberData(contract ISuperfluidToken,address,contract ISuperfluidPool) (NodeID: 11)
    │   💬 Args: [token, msgSender, pool]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: GeneralDistributionAgreementV1._decodePoolMemberData(uint256) (NodeID: 12)
    │     💬 Args: [uint256(token.getAgreementData(address(this), _getPoolMemberHash(poolMember, pool), 1)[0])]
    │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: GeneralDistributionAgreementV1._getPoolMemberHash(address,contract ISuperfluidPool) (NodeID: 13)
    │       💬 Args: [poolMember, pool]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: GeneralDistributionAgreementV1._getPoolMemberHash(address,contract ISuperfluidPool) (NodeID: 14)
    │   💬 Args: [msgSender, pool]
    │   👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: GeneralDistributionAgreementV1._clearPoolConnectionsBitmap(contract ISuperfluidToken,address,uint32) (NodeID: 15)
        💬 Args: [token, msgSender, poolMemberData.poolID]
        👁️  Def: private
      └─ [3] ⚙️ FUNCTION: SlotsBitmapLibrary.clearSlot(contract ISuperfluidToken,address,uint256,uint32) (NodeID: 16)
