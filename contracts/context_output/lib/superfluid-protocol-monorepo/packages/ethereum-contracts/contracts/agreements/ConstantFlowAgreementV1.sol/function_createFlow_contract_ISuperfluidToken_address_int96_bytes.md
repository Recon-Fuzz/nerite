# Function: createFlow(contract ISuperfluidToken,address,int96,bytes)
...
```
┌─ [0] ⚙️ FUNCTION: ConstantFlowAgreementV1.createFlow(contract ISuperfluidToken,address,int96,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: AgreementLibrary.authorizeTokenAccess(contract ISuperfluidToken,bytes) (NodeID: 1)
  │   💬 Args: [token, ctx]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: ConstantFlowAgreementV1._createFlow(struct ConstantFlowAgreementV1._StackVars_createOrUpdateFlow,bytes,struct ISuperfluid.Context) (NodeID: 2)
      💬 Args: [flowVars, ctx, currentContext]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1._createOrUpdateFlowCheck(struct ConstantFlowAgreementV1._StackVars_createOrUpdateFlow,struct ISuperfluid.Context) (NodeID: 3)
    │   💬 Args: [flowVars, currentContext]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._generateFlowId(address,address) (NodeID: 4)
    │     💬 Args: [flowVars.sender, flowVars.receiver]
    │     👁️  Def: private
    ├─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAgreementData(contract ISuperfluidToken,bytes32) (NodeID: 5)
    │   💬 Args: [flowVars.token, flowId]
    │   👁️  Def: private
    │ └─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 6)
    │     💬 Args: [uint256(data[0])]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1._changeFlowToApp(address,contract ISuperfluidToken,struct ConstantFlowAgreementV1.FlowParams,struct ConstantFlowAgreementV1.FlowData,bytes,struct ISuperfluid.Context,enum ConstantFlowAgreementV1.FlowChangeType) (NodeID: 7)
    │   💬 Args: [flowVars.receiver, flowVars.token, flowParams, oldFlowData, ctx, currentContext, FlowChangeType.CREATE_FLOW]
    │   👁️  Def: private
    │ ├─ [3] ⚙️ FUNCTION: AgreementLibrary.createCallbackInputs(contract ISuperfluidToken,address,bytes32,bytes) (NodeID: 8)
    │ │   💬 Args: [token, appToCallback, flowParams.flowId, abi.encode(flowParams.sender, flowParams.receiver)]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: AgreementLibrary.callAppBeforeCallback(struct AgreementLibrary.CallbackInputs,bytes) (NodeID: 9)
    │ │   💬 Args: [cbStates, ctx]
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: AgreementLibrary._pushCallbackStack(bytes,struct AgreementLibrary.CallbackInputs) (NodeID: 10)
    │ │ │   💬 Args: [ctx, inputs]
    │ │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: AgreementLibrary._selectorFromNoopBit(uint256) (NodeID: 11)
    │ │ │   💬 Args: [inputs.noopBit]
    │ │ │   👁️  Def: private
    │ │ └─ [4] ⚙️ FUNCTION: AgreementLibrary._popCallbackStack(bytes,int256) (NodeID: 12)
    │ │     💬 Args: [ctx, 0]
    │ │     👁️  Def: private
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._changeFlow(uint256,contract ISuperfluidToken,contract ISuperfluidToken,struct ConstantFlowAgreementV1.FlowParams,struct ConstantFlowAgreementV1.FlowData) (NodeID: 13)
    │ │   💬 Args: [currentContext.timestamp, currentContext.appCreditToken, token, flowParams, oldFlowData]
    │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: SolvencyHelperLibrary.decode3PsData(contract ISuperfluid,contract ISuperfluidToken) (NodeID: 14)
    │ │ │   💬 Args: [ISuperfluid(_host), token]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: SuperfluidGovernanceConfigs.decodePPPConfig(uint256) (NodeID: 15)
    │ │ │     💬 Args: [pppConfig]
    │ │ │     👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._calculateDeposit(int96,uint256) (NodeID: 16)
    │ │ │   💬 Args: [flowParams.flowRate, liquidationPeriod]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._clipDepositNumberRoundingUp(uint256) (NodeID: 17)
    │ │ │     💬 Args: [deposit]
    │ │ │     👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 18)
    ...
    │ │ │   💬 Args: [oldFlowData.deposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 22)
    │ │ │   💬 Args: [(oldFlowData.deposit.toInt256() + depositDelta)]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 23)
    │ │ │   💬 Args: [oldFlowData.owedDeposit]
    │ │ │   👁️  Def: internal
    ...
    │ │ │   💬 Args: [minimumDeposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 26)
    │ │ │   💬 Args: [newFlowData]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 27)
    │ │ │   💬 Args: [token, flowParams.sender, oldFlowData.flowRate - flowParams.flowRate, depositDelta, 0, currentTimestamp]
    │ │ │   👁️  Def: private
    │ │ │ ├─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 28)
    │ │ │ │   💬 Args: [token, account]
    │ │ │ │   👁️  Def: private
    │ │ │ │ └─ [6] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 29)
    │ │ │ │     💬 Args: [uint256(data[0])]
    │ │ │ │     👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 30)
    │ │ │ │   💬 Args: [(currentTimestamp - state.timestamp)]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 31)
    │ │ │ │   💬 Args: [state.deposit]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 32)
    │ │ │ │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 33)
    │ │ │ │   💬 Args: [state.owedDeposit]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 34)
    │ │ │ │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │ │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 35)
    │ │ │     💬 Args: [state]
    │ │ │     👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 36)
    │ │     💬 Args: [token, flowParams.receiver, flowParams.flowRate - oldFlowData.flowRate, 0, 0, currentTimestamp]
    │ │     👁️  Def: private
    │ │   ├─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 37)
    │ │   │   💬 Args: [token, account]
    │ │   │   👁️  Def: private
    │ │   │ └─ [6] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 38)
    │ │   │     💬 Args: [uint256(data[0])]
    │ │   │     👁️  Def: internal
    ...
    │ │   │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │ │   │   👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 42)
    │ │   │   💬 Args: [state.owedDeposit]
    │ │   │   👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 43)
    │ │   │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │ │   │   👁️  Def: internal
    │ │   └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 44)
    │ │       💬 Args: [state]
    │ │       👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: AgreementLibrary.max(uint256,uint256) (NodeID: 45)
    │ │   💬 Args: [DEFAULT_MINIMUM_DEPOSIT, minimumDeposit]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 46)
    │ │   💬 Args: [oldFlowData.owedDeposit]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: AgreementLibrary.callAppAfterCallback(struct AgreementLibrary.CallbackInputs,bytes,bytes) (NodeID: 47)
    │ │   💬 Args: [cbStates, vars.cbdata, newCtx]
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: AgreementLibrary._pushCallbackStack(bytes,struct AgreementLibrary.CallbackInputs) (NodeID: 48)
    │ │ │   💬 Args: [newCtx, inputs]
    │ │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: AgreementLibrary._selectorFromNoopBit(uint256) (NodeID: 49)
    │ │ │   💬 Args: [inputs.noopBit]
    │ │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: AgreementLibrary._adjustNewAppCreditUsed(uint256,int256) (NodeID: 50)
    │ │ │   💬 Args: [inputs.appCreditGranted, appContext.appCreditUsed]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: AgreementLibrary.max(int256,int256) (NodeID: 51)
    │ │ │     💬 Args: [0, min(appCreditGranted.toInt256(), appCallbackDepositDelta)]
    │ │ │     👁️  Def: internal
    │ │ │   └─ [6] ⚙️ FUNCTION: AgreementLibrary.min(int256,int256) (NodeID: 52)
    │ │ │       💬 Args: [appCreditGranted.toInt256(), appCallbackDepositDelta]
    │ │ │       👁️  Def: internal
    │ │ │     └─ [7] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 53)
    │ │ │         💬 Args: [appCreditGranted]
    │ │ │         👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: AgreementLibrary._popCallbackStack(bytes,int256) (NodeID: 54)
    │ │     💬 Args: [ctx, appContext.appCreditUsed]
    │ │     👁️  Def: private
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAgreementData(contract ISuperfluidToken,bytes32) (NodeID: 55)
    │ │   💬 Args: [token, flowParams.flowId]
    │ │   👁️  Def: private
    │ │ └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 56)
    │ │     💬 Args: [uint256(data[0])]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._changeFlow(uint256,contract ISuperfluidToken,contract ISuperfluidToken,struct ConstantFlowAgreementV1.FlowParams,struct ConstantFlowAgreementV1.FlowData) (NodeID: 57)
    │ │   💬 Args: [currentContext.timestamp, currentContext.appCreditToken, token, flowParams, oldFlowData]
    │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: SolvencyHelperLibrary.decode3PsData(contract ISuperfluid,contract ISuperfluidToken) (NodeID: 58)
    │ │ │   💬 Args: [ISuperfluid(_host), token]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: SuperfluidGovernanceConfigs.decodePPPConfig(uint256) (NodeID: 59)
    │ │ │     💬 Args: [pppConfig]
    │ │ │     👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._calculateDeposit(int96,uint256) (NodeID: 60)
    │ │ │   💬 Args: [flowParams.flowRate, liquidationPeriod]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._clipDepositNumberRoundingUp(uint256) (NodeID: 61)
    │ │ │     💬 Args: [deposit]
    │ │ │     👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 62)
    │ │ │   💬 Args: [oldFlowData.owedDeposit]
    │ │ │   👁️  Def: internal
    ...
    │ │ │   💬 Args: [oldFlowData.deposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 66)
    │ │ │   💬 Args: [(oldFlowData.deposit.toInt256() + depositDelta)]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 67)
    │ │ │   💬 Args: [oldFlowData.owedDeposit]
    │ │ │   👁️  Def: internal
    ...
    │ │ │   💬 Args: [minimumDeposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 70)
    │ │ │   💬 Args: [newFlowData]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 71)
    │ │ │   💬 Args: [token, flowParams.sender, oldFlowData.flowRate - flowParams.flowRate, depositDelta, 0, currentTimestamp]
    │ │ │   👁️  Def: private
    │ │ │ ├─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 72)
    │ │ │ │   💬 Args: [token, account]
    │ │ │ │   👁️  Def: private
    │ │ │ │ └─ [6] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 73)
    │ │ │ │     💬 Args: [uint256(data[0])]
    │ │ │ │     👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 74)
    │ │ │ │   💬 Args: [(currentTimestamp - state.timestamp)]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 75)
    │ │ │ │   💬 Args: [state.deposit]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 76)
    │ │ │ │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 77)
    │ │ │ │   💬 Args: [state.owedDeposit]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 78)
    │ │ │ │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │ │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 79)
    │ │ │     💬 Args: [state]
    │ │ │     👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 80)
    │ │     💬 Args: [token, flowParams.receiver, flowParams.flowRate - oldFlowData.flowRate, 0, 0, currentTimestamp]
    │ │     👁️  Def: private
    │ │   ├─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 81)
    │ │   │   💬 Args: [token, account]
    │ │   │   👁️  Def: private
    │ │   │ └─ [6] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 82)
    │ │   │     💬 Args: [uint256(data[0])]
    │ │   │     👁️  Def: internal
    ...
    │ │   │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │ │   │   👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 86)
    │ │   │   💬 Args: [state.owedDeposit]
    │ │   │   👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 87)
    │ │   │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │ │   │   👁️  Def: internal
    │ │   └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 88)
    │ │       💬 Args: [state]
    │ │       👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 89)
    │ │   💬 Args: [oldFlowData.owedDeposit]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 90)
    │ │   💬 Args: [vars.newFlowData.deposit]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 91)
    │ │   💬 Args: [(vars.newFlowData.deposit.toInt256() + appCreditDelta)]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 92)
    │ │   💬 Args: [vars.newFlowData.owedDeposit]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 93)
    │ │   💬 Args: [(vars.newFlowData.owedDeposit.toInt256() + appCreditDelta)]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 94)
    │ │   💬 Args: [vars.newFlowData]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 95)
    │ │   💬 Args: [token, flowParams.sender, 0, appCreditDelta, 0, currentContext.timestamp]
    │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 96)
    │ │ │   💬 Args: [token, account]
    │ │ │   👁️  Def: private
    │ │ │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 97)
    │ │ │     💬 Args: [uint256(data[0])]
    │ │ │     👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 98)
    │ │ │   💬 Args: [(currentTimestamp - state.timestamp)]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 99)
    │ │ │   💬 Args: [state.deposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 100)
    │ │ │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 101)
    │ │ │   💬 Args: [state.owedDeposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 102)
    │ │ │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │ │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 103)
    │ │     💬 Args: [state]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 104)
    │ │   💬 Args: [token, flowParams.receiver, 0, 0, appCreditDelta, currentContext.timestamp]
    │ │   👁️  Def: private
    │ │ ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 105)
    │ │ │   💬 Args: [token, account]
    │ │ │   👁️  Def: private
    │ │ │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 106)
    │ │ │     💬 Args: [uint256(data[0])]
    │ │ │     👁️  Def: internal
    ...
    │ │ │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 110)
    │ │ │   💬 Args: [state.owedDeposit]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 111)
    │ │ │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │ │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 112)
    │ │     💬 Args: [state]
    │ │     👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: AgreementLibrary.min(int256,int256) (NodeID: 113)
    │     💬 Args: [-availableBalance, -appCreditDelta]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1._changeFlowToNonApp(contract ISuperfluidToken,struct ConstantFlowAgreementV1.FlowParams,struct ConstantFlowAgreementV1.FlowData,bytes,struct ISuperfluid.Context) (NodeID: 114)
    │   💬 Args: [flowVars.token, flowParams, oldFlowData, ctx, currentContext]
    │   👁️  Def: private
    │ └─ [3] ⚙️ FUNCTION: ConstantFlowAgreementV1._changeFlow(uint256,contract ISuperfluidToken,contract ISuperfluidToken,struct ConstantFlowAgreementV1.FlowParams,struct ConstantFlowAgreementV1.FlowData) (NodeID: 115)
    │     💬 Args: [currentContext.timestamp, currentContext.appCreditToken, token, flowParams, oldFlowData]
    │     👁️  Def: private
    │   ├─ [4] ⚙️ FUNCTION: SolvencyHelperLibrary.decode3PsData(contract ISuperfluid,contract ISuperfluidToken) (NodeID: 116)
    │   │   💬 Args: [ISuperfluid(_host), token]
    │   │   👁️  Def: internal
    │   │ └─ [5] ⚙️ FUNCTION: SuperfluidGovernanceConfigs.decodePPPConfig(uint256) (NodeID: 117)
    │   │     💬 Args: [pppConfig]
    │   │     👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._calculateDeposit(int96,uint256) (NodeID: 118)
    │   │   💬 Args: [flowParams.flowRate, liquidationPeriod]
    │   │   👁️  Def: internal
    │   │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._clipDepositNumberRoundingUp(uint256) (NodeID: 119)
    │   │     💬 Args: [deposit]
    │   │     👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 120)
    │   │   💬 Args: [oldFlowData.owedDeposit]
    │   │   👁️  Def: internal
    ...
    │   │   💬 Args: [oldFlowData.deposit]
    │   │   👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 124)
    │   │   💬 Args: [(oldFlowData.deposit.toInt256() + depositDelta)]
    │   │   👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 125)
    │   │   💬 Args: [oldFlowData.owedDeposit]
    │   │   👁️  Def: internal
    ...
    │   │   💬 Args: [minimumDeposit]
    │   │   👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 128)
    │   │   💬 Args: [newFlowData]
    │   │   👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 129)
    │   │   💬 Args: [token, flowParams.sender, oldFlowData.flowRate - flowParams.flowRate, depositDelta, 0, currentTimestamp]
    │   │   👁️  Def: private
    │   │ ├─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 130)
    │   │ │   💬 Args: [token, account]
    │   │ │   👁️  Def: private
    │   │ │ └─ [6] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 131)
    │   │ │     💬 Args: [uint256(data[0])]
    │   │ │     👁️  Def: internal
    │   │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 132)
    │   │ │   💬 Args: [(currentTimestamp - state.timestamp)]
    │   │ │   👁️  Def: internal
    │   │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 133)
    │   │ │   💬 Args: [state.deposit]
    │   │ │   👁️  Def: internal
    │   │ ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 134)
    │   │ │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │   │ │   👁️  Def: internal
    │   │ ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 135)
    │   │ │   💬 Args: [state.owedDeposit]
    │   │ │   👁️  Def: internal
    │   │ ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 136)
    │   │ │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │   │ │   👁️  Def: internal
    │   │ └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 137)
    │   │     💬 Args: [state]
    │   │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: ConstantFlowAgreementV1._updateAccountFlowState(contract ISuperfluidToken,address,int96,int256,int256,uint256) (NodeID: 138)
    │       💬 Args: [token, flowParams.receiver, flowParams.flowRate - oldFlowData.flowRate, 0, 0, currentTimestamp]
    │       👁️  Def: private
    │     ├─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._getAccountFlowState(contract ISuperfluidToken,address) (NodeID: 139)
    │     │   💬 Args: [token, account]
    │     │   👁️  Def: private
    │     │ └─ [6] ⚙️ FUNCTION: ConstantFlowAgreementV1._decodeFlowData(uint256) (NodeID: 140)
    │     │     💬 Args: [uint256(data[0])]
    │     │     👁️  Def: internal
    ...
    │     │   💬 Args: [(state.deposit.toInt256() + depositDelta)]
    │     │   👁️  Def: internal
    │     ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 144)
    │     │   💬 Args: [state.owedDeposit]
    │     │   👁️  Def: internal
    │     ├─ [5] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 145)
    │     │   💬 Args: [(state.owedDeposit.toInt256() + owedDepositDelta)]
    │     │   👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: ConstantFlowAgreementV1._encodeFlowData(struct ConstantFlowAgreementV1.FlowData) (NodeID: 146)
    │         💬 Args: [state]
    │         👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: ConstantFlowAgreementV1._requireAvailableBalance(contract ISuperfluidToken,address,struct ISuperfluid.Context) (NodeID: 147)
