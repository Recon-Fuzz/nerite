...
- **Name**: PoolMemberNFT
- **Type**: Contract
- **Path**: lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/agreements/gdav1/PoolMemberNFT.sol
...
### PoolMemberNFTData (inherited from IPoolMemberNFT)
...
### POOL_MEMBER_NFT_NO_ZERO_POOL (inherited from IPoolMemberNFT)
...
### POOL_MEMBER_NFT_NO_ZERO_MEMBER (inherited from IPoolMemberNFT)

```solidity
error POOL_MEMBER_NFT_NO_ZERO_MEMBER();
```

### POOL_MEMBER_NFT_NO_UNITS (inherited from IPoolMemberNFT)

```solidity
error POOL_MEMBER_NFT_NO_UNITS();
```

### POOL_MEMBER_NFT_HAS_UNITS (inherited from IPoolMemberNFT)
...
- **Details**: [function_poolMemberDataByTokenId_uint256.md](./function_poolMemberDataByTokenId_uint256.md)
...
- **Details**: [function_onCreate_address_address.md](./function_onCreate_address_address.md)
...
- **Details**: [function_onUpdate_address_address.md](./function_onUpdate_address_address.md)
...
- **Details**: [function_onDelete_address_address.md](./function_onDelete_address_address.md)
