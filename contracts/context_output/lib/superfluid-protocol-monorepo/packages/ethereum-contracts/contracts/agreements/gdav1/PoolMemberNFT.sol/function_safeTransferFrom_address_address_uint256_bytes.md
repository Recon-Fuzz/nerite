...
- **Kind**: internal
- **Source**: 2029:181:125
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/agreements/gdav1/PoolMemberNFT.sol:PoolMemberNFT:_transfer(address,address,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: PoolNFTBase.safeTransferFrom(address,address,uint256,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │ │       💬 Args: [tokenId]
  │ │       👁️  Def: internal
  │ │     └─ [5] ⚙️ FUNCTION: PoolMemberNFT._ownerOf(uint256) (NodeID: 7)
  │ │         💬 Args: [tokenId]
  │ │         👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: PoolNFTBase.isApprovedForAll(address,address) (NodeID: 8)
  │     💬 Args: [owner, spender]
  │     👁️  Def: public
  └─ [1] ⚙️ FUNCTION: PoolNFTBase._safeTransfer(address,address,uint256,bytes) (NodeID: 9)
      💬 Args: [from, to, tokenId, data]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: PoolMemberNFT._transfer(address,address,uint256) (NodeID: 10)
