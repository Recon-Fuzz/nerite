# Function: increaseFlowRateAllowanceWithPermissions(contract ISuperfluidToken,address,uint8,int96,bytes)
...
```
┌─ [0] ⚙️ FUNCTION: ConstantFlowAgreementV1.increaseFlowRateAllowanceWithPermissions(contract ISuperfluidToken,address,uint8,int96,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [uint256(data[0])]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ConstantFlowAgreementV1.addPermissions(uint8,uint8) (NodeID: 8)
