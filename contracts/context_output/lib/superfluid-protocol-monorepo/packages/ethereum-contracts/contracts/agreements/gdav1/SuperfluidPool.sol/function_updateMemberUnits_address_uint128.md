# Function: updateMemberUnits(address,uint128)
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidPool.updateMemberUnits(address,uint128) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: SuperfluidPool._updateMemberUnits(address,uint128) (NodeID: 1)
    ...
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Unknown.poolIndexDataToPDPoolIndex(struct SuperfluidPool.PoolIndexData) (NodeID: 5)
    │   💬 Args: [_index]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: Unknown.toSemanticMoneyUnit(uint128) (NodeID: 6)
    │ │   💬 Args: [data.totalUnits]
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 7)
    │ │ │   💬 Args: [uint256(units)]
    │ │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: SafeCast.toInt128(int256) (NodeID: 8)
    │ │     💬 Args: [uint256(units).toInt256()]
    │ │     👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Unknown.poolIndexDataToWrappedParticle(struct SuperfluidPool.PoolIndexData) (NodeID: 9)
    │     💬 Args: [data]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SuperfluidPool._memberDataToPDPoolMember(struct SuperfluidPool.MemberData) (NodeID: 10)
    │   💬 Args: [memberData]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Unknown.toSemanticMoneyUnit(uint128) (NodeID: 11)
    │     💬 Args: [memberData.ownedUnits]
    │     👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 12)
    │   │   💬 Args: [uint256(units)]
    │   │   👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: SafeCast.toInt128(int256) (NodeID: 13)
    │       💬 Args: [uint256(units).toInt256()]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SuperfluidPool._shiftDisconnectedUnits(Unit,Value,Time) (NodeID: 14)
    ...
    │ │     💬 Args: [data]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SuperfluidPool._memberDataToPDPoolMember(struct SuperfluidPool.MemberData) (NodeID: 20)
    │ │   💬 Args: [_disconnectedMembers]
    │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: Unknown.toSemanticMoneyUnit(uint128) (NodeID: 21)
    │ │     💬 Args: [memberData.ownedUnits]
    │ │     👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 22)
    │ │   │   💬 Args: [uint256(units)]
    │ │   │   👁️  Def: internal
    │ │   └─ [5] ⚙️ FUNCTION: SafeCast.toInt128(int256) (NodeID: 23)
    │ │       💬 Args: [uint256(units).toInt256()]
    │ │       👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SemanticMoney.settle(struct PDPoolMemberMU,Time) (NodeID: 24)
    │ │   💬 Args: [mu, t]
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SemanticMoney.settle(struct PDPoolIndex,Time) (NodeID: 25)
    │ │ │   💬 Args: [a.i, t]
    │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SemanticMoney.clone(struct PDPoolIndex) (NodeID: 26)
    │ │ │ │   💬 Args: [a]
    │ │ │ │   👁️  Def: internal
    │ │ │ │ └─ [6] ⚙️ FUNCTION: SemanticMoney.clone(struct BasicParticle) (NodeID: 27)
    │ │ │ │     💬 Args: [a._wrapped_particle]
    │ │ │ │     👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: SemanticMoney.settle(struct BasicParticle,Time) (NodeID: 28)
    │ │ │     💬 Args: [m._wrapped_particle, t]
    │ │ │     👁️  Def: internal
    │ │ │   ├─ [6] ⚙️ FUNCTION: SemanticMoney.clone(struct BasicParticle) (NodeID: 29)
    │ │ │   │   💬 Args: [a]
    │ │ │   │   👁️  Def: internal
    │ │ │   └─ [6] ⚙️ FUNCTION: SemanticMoney.rtb(struct BasicParticle,Time) (NodeID: 30)
    │ │ │       💬 Args: [a, t]
    │ │ │       👁️  Def: internal
    │ │ │     └─ [7] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.mul(FlowRate,Time) (NodeID: 31)
    │ │ │         💬 Args: [a._flow_rate, t - a._settled_at]
    │ │ │         👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SemanticMoney.clone(struct PDPoolMember) (NodeID: 32)
    │ │ │   💬 Args: [a.m]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: SemanticMoney.clone(struct BasicParticle) (NodeID: 33)
    │ │ │     💬 Args: [a._synced_particle]
    │ │ │     👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: SemanticMoney.rtb(struct PDPoolMemberMU,Time) (NodeID: 34)
    │ │     💬 Args: [a, t]
    │ │     👁️  Def: internal
    ...
    │ │   │   👁️  Def: internal
    │ │   │ ├─ [6] ⚙️ FUNCTION: SemanticMoney.settled_at(struct BasicParticle) (NodeID: 37)
    ...
    │ │   │     💬 Args: [a._flow_rate, t - a._settled_at]
    │ │   │     👁️  Def: internal
    │ │   └─ [5] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.mul(Value,Unit) (NodeID: 40)
    │ │       💬 Args: [(a.i._wrapped_particle.rtb(t) - a.m._synced_particle.rtb(a.m._synced_particle.settled_at())), a.m.owned_units]
    │ │       👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: SuperfluidPool._pdPoolMemberToMemberData(struct PDPoolMember,int256) (NodeID: 41)
    │     💬 Args: [mu.m, 0]
    │     👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: SafeCast.toUint128(uint256) (NodeID: 42)
    │   │   💬 Args: [uint256(int256(Unit.unwrap(pdPoolMember.owned_units)))]
    │   │   👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: SafeCast.toInt96(int256) (NodeID: 43)
    │       💬 Args: [int256(FlowRate.unwrap(pdPoolMember._synced_particle._flow_rate))]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SemanticMoney.pool_member_update(struct PDPoolMemberMU,struct BasicParticle,Unit,Time) (NodeID: 44)
    │   💬 Args: [mu, p, wrappedUnits, t]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SemanticMoney.settle(struct PDPoolMemberMU,Time) (NodeID: 45)
    │ │   💬 Args: [b1, t]
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SemanticMoney.settle(struct PDPoolIndex,Time) (NodeID: 46)
    │ │ │   💬 Args: [a.i, t]
    │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: SemanticMoney.clone(struct PDPoolIndex) (NodeID: 47)
    │ │ │ │   💬 Args: [a]
    │ │ │ │   👁️  Def: internal
    │ │ │ │ └─ [6] ⚙️ FUNCTION: SemanticMoney.clone(struct BasicParticle) (NodeID: 48)
    │ │ │ │     💬 Args: [a._wrapped_particle]
    │ │ │ │     👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: SemanticMoney.settle(struct BasicParticle,Time) (NodeID: 49)
    │ │ │     💬 Args: [m._wrapped_particle, t]
    │ │ │     👁️  Def: internal
    │ │ │   ├─ [6] ⚙️ FUNCTION: SemanticMoney.clone(struct BasicParticle) (NodeID: 50)
    │ │ │   │   💬 Args: [a]
    │ │ │   │   👁️  Def: internal
    │ │ │   └─ [6] ⚙️ FUNCTION: SemanticMoney.rtb(struct BasicParticle,Time) (NodeID: 51)
    │ │ │       💬 Args: [a, t]
    │ │ │       👁️  Def: internal
    │ │ │     └─ [7] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.mul(FlowRate,Time) (NodeID: 52)
    │ │ │         💬 Args: [a._flow_rate, t - a._settled_at]
    │ │ │         👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SemanticMoney.clone(struct PDPoolMember) (NodeID: 53)
    │ │ │   💬 Args: [a.m]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: SemanticMoney.clone(struct BasicParticle) (NodeID: 54)
    │ │ │     💬 Args: [a._synced_particle]
    │ │ │     👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: SemanticMoney.rtb(struct PDPoolMemberMU,Time) (NodeID: 55)
    │ │     💬 Args: [a, t]
    │ │     👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SemanticMoney.rtb(struct BasicParticle,Time) (NodeID: 56)
    │ │   │   💬 Args: [a.m._synced_particle, a.m._synced_particle.settled_at()]
    │ │   │   👁️  Def: internal
    │ │   │ ├─ [6] ⚙️ FUNCTION: SemanticMoney.settled_at(struct BasicParticle) (NodeID: 58)
    │ │   │ │   💬 Args: [a.m._synced_particle]
    │ │   │ │   👁️  Def: internal
    │ │   │ └─ [6] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.mul(FlowRate,Time) (NodeID: 57)
    │ │   │     💬 Args: [a._flow_rate, t - a._settled_at]
    │ │   │     👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: SemanticMoney.rtb(struct BasicParticle,Time) (NodeID: 59)
    │ │   │   💬 Args: [a.i._wrapped_particle, t]
    │ │   │   👁️  Def: internal
    │ │   │ └─ [6] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.mul(FlowRate,Time) (NodeID: 60)
    │ │   │     💬 Args: [a._flow_rate, t - a._settled_at]
    │ │   │     👁️  Def: internal
    │ │   └─ [5] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.mul(Value,Unit) (NodeID: 61)
    │ │       💬 Args: [(a.i._wrapped_particle.rtb(t) - a.m._synced_particle.rtb(a.m._synced_particle.settled_at())), a.m.owned_units]
    │ │       👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.mul_quotrem(FlowRate,Unit,Unit) (NodeID: 62)
    │ │   💬 Args: [nr, oldTotalUnit, newTotalUnit]
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.mul(FlowRate,Unit) (NodeID: 63)
    │ │ │   💬 Args: [r, u1]
    │ │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.quotrem(FlowRate,Unit) (NodeID: 64)
    │ │     💬 Args: [r.mul(u1), u2]
    │ │     👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.div(FlowRate,Unit) (NodeID: 65)
    │ │   │   💬 Args: [r, u]
    │ │   │   👁️  Def: internal
    │ │   └─ [5] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.mul(FlowRate,Unit) (NodeID: 66)
    │ │       💬 Args: [nr, u]
    │ │       👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.mul(FlowRate,Unit) (NodeID: 67)
    ...
    │ │     💬 Args: [a]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SemanticMoney.settle(struct BasicParticle,Time) (NodeID: 70)
    │ │   💬 Args: [a, t]
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: SemanticMoney.clone(struct BasicParticle) (NodeID: 71)
    │ │ │   💬 Args: [a]
    │ │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: SemanticMoney.rtb(struct BasicParticle,Time) (NodeID: 72)
    │ │     💬 Args: [a, t]
    │ │     👁️  Def: internal
    │ │   └─ [5] ⚙️ FUNCTION: AdditionalMonetaryTypeHelpers.mul(FlowRate,Time) (NodeID: 73)
    │ │       💬 Args: [a._flow_rate, t - a._settled_at]
    │ │       👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SemanticMoney.flow1(struct BasicParticle,FlowRate) (NodeID: 74)
    │ │   💬 Args: [a.settle(t), a._flow_rate + er]
    │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: SemanticMoney.clone(struct BasicParticle) (NodeID: 75)
    │ │     💬 Args: [a]
    │ │     👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: SemanticMoney.clone(struct BasicParticle) (NodeID: 76)
    │     💬 Args: [b1s.i._wrapped_particle]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SuperfluidPool._pdPoolIndexToPoolIndexData(struct PDPoolIndex) (NodeID: 77)
    │   💬 Args: [pdPoolIndex]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toUint256(int256) (NodeID: 78)
    │ │   💬 Args: [int256(Unit.unwrap(pdPoolIndex.total_units))]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toUint128(uint256) (NodeID: 79)
    │ │   💬 Args: [int256(Unit.unwrap(pdPoolIndex.total_units)).toUint256()]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SemanticMoney.settled_at(struct PDPoolIndex) (NodeID: 80)
    │ │   💬 Args: [pdPoolIndex]
    │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: SemanticMoney.settled_at(struct BasicParticle) (NodeID: 81)
    │ │     💬 Args: [a._wrapped_particle]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SemanticMoney.flow_rate_per_unit(struct PDPoolIndex) (NodeID: 82)
    │ │   💬 Args: [pdPoolIndex]
    │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: SemanticMoney.flow_rate(struct BasicParticle) (NodeID: 83)
    │ │     💬 Args: [a._wrapped_particle]
    │ │     👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: SafeCast.toInt96(int256) (NodeID: 84)
    │     💬 Args: [int256(FlowRate.unwrap(pdPoolIndex.flow_rate_per_unit()))]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SuperfluidPool._pdPoolMemberToMemberData(struct PDPoolMember,int256) (NodeID: 85)
    │   💬 Args: [pdPoolMember, claimedValue]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: SafeCast.toUint128(uint256) (NodeID: 86)
    │ │   💬 Args: [uint256(int256(Unit.unwrap(pdPoolMember.owned_units)))]
    │ │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: SafeCast.toInt96(int256) (NodeID: 87)
    │     💬 Args: [int256(FlowRate.unwrap(pdPoolMember._synced_particle._flow_rate))]
    │     👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: SuperfluidPool._handlePoolMemberNFT(address,uint128) (NodeID: 88)
        💬 Args: [memberAddr, newUnits]
        👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: SuperfluidPool._canCallNFTHook(contract ISuperfluidToken) (NodeID: 89)
          💬 Args: [superToken]
          👁️  Def: internal
```
