...
```
┌─ [0] ⚙️ FUNCTION: SuperToken.operatorBurn(address,uint256,bytes,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: ERC777Helper.isOperatorFor(struct ERC777Helper.Operators,address,address) (NodeID: 1)
  │   💬 Args: [_operators, operator, account]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: SuperToken._downgrade(address,address,address,uint256,bytes,bytes) (NodeID: 2)
      💬 Args: [operator, account, account, amount, userData, operatorData]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SuperToken._toUnderlyingAmount(uint256) (NodeID: 3)
    │   💬 Args: [amount]
    │   👁️  Def: private
    └─ [2] ⚙️ FUNCTION: SuperToken._burn(address,address,uint256,bool,bytes,bytes) (NodeID: 4)
        💬 Args: [operator, account, adjustedAmount, userData.length != 0, userData, operatorData]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: SuperToken._callTokensToSend(address,address,address,uint256,bytes,bytes) (NodeID: 5)
      │   💬 Args: [operator, from, address(0), amount, userData, operatorData]
      │   👁️  Def: private
      └─ [3] ⚙️ FUNCTION: SuperfluidToken._burn(address,uint256) (NodeID: 6)
          💬 Args: [from, amount]
          👁️  Def: internal
        ├─ [4] ⚙️ FUNCTION: SuperfluidToken.realtimeBalanceOf(address,uint256) (NodeID: 7)
        │   💬 Args: [account, _host.getNow()]
        │   👁️  Def: public
        │ ├─ [5] ⚙️ FUNCTION: SuperfluidToken.getAccountActiveAgreements(address) (NodeID: 8)
        │ │   💬 Args: [account]
        │ │   👁️  Def: public
        │ └─ [5] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 9)
        ...
        │   💬 Args: [amount]
        │   👁️  Def: internal
        └─ [4] ⚙️ FUNCTION: SafeCast.toInt256(uint256) (NodeID: 11)
            💬 Args: [amount]
            👁️  Def: internal
```
