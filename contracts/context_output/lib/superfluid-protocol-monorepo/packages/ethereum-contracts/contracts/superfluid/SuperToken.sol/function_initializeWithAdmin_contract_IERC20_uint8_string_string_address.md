# Function: initializeWithAdmin(contract IERC20,uint8,string,string,address)
...
```
┌─ [0] ⚙️ FUNCTION: SuperToken.initializeWithAdmin(contract IERC20,uint8,string,string,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: SuperToken._initialize(contract IERC20,uint8,string,string,address) (NodeID: 1)
  │   💬 Args: [underlyingToken, underlyingDecimals, n, s, admin]
  │   👁️  Def: internal
