# Function: forwardBatchCall(struct ISuperfluid.Operation[])
...
- **Kind**: internal
- **Source**: 968:504:152
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/libs/BaseRelayRecipient.sol:BaseRelayRecipient:_getTransactionSigner()`
...
function _getTransactionSigner() virtual internal view returns (address payable ret) {
...
- **Kind**: internal
- **Source**: 35887:305:163
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/superfluid/Superfluid.sol:Superfluid:isTrustedForwarder(address)`
...
```
┌─ [0] ⚙️ FUNCTION: Superfluid.forwardBatchCall(struct ISuperfluid.Operation[]) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: Superfluid._batchCall(address payable,struct ISuperfluid.Operation[]) (NodeID: 1)
      💬 Args: [_getTransactionSigner(), operations]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseRelayRecipient._getTransactionSigner() (NodeID: 34)
    │   💬 Args: [no args]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Superfluid.isTrustedForwarder(address) (NodeID: 35)
    │     💬 Args: [msg.sender]
    │     👁️  Def: public
    │   └─ [4] ⚙️ FUNCTION: SuperfluidGovernanceConfigs.getTrustedForwarderConfigKey(address) (NodeID: 36)
    │       💬 Args: [forwarder]
    │       👁️  Def: internal
