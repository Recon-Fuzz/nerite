# Function: isAccountCriticalNow(address)
...
- **Kind**: internal
- **Source**: 3960:280:164
- **Link**: `lib/superfluid-protocol-monorepo/packages/ethereum-contracts/contracts/superfluid/SuperfluidToken.sol:SuperfluidToken:isAccountCritical(address,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: SuperfluidToken.isAccountCriticalNow(address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: SuperfluidToken.isAccountCritical(address,uint256) (NodeID: 1)
