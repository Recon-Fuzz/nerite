# Function: selfTransferFrom(address,address,address,uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SuperToken.selfTransferFrom(address,address,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: SuperToken._transferFrom(address,address,address,uint256) (NodeID: 1)
  │   💬 Args: [spender, holder, recipient, amount]
  │   👁️  Def: internal
  ...
  │       👁️  Def: internal
  └─ [1] 🔒 MODIFIER: SuperToken.onlySelf() (NodeID: 10)
      💬 Args: [no args]
```
