# Function: callAppBeforeCallback(contract ISuperApp,bytes,bool,bytes)
...
```
┌─ [0] ⚙️ FUNCTION: Superfluid.callAppBeforeCallback(contract ISuperApp,bytes,bool,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: Superfluid._callCallback(contract ISuperApp,bool,bool,bytes,bytes) (NodeID: 1)
  │   💬 Args: [app, true, isTermination, callData, ctx]
  │   👁️  Def: private
  ...
  │     💬 Args: [bytesLen]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Superfluid._jailApp(contract ISuperApp,uint256) (NodeID: 10)
  │   💬 Args: [app, SuperAppDefinitions.APP_RULE_CTX_IS_MALFORMATED]
  │   👁️  Def: internal
  ├─ [1] 🔒 MODIFIER: Superfluid.assertValidCtx(bytes) (NodeID: 11)
  │   💬 Args: [ctx]
  │ └─ [2] ⚙️ FUNCTION: Superfluid._isCtxValid(bytes) (NodeID: 12)
  │     💬 Args: [ctx]
  │     👁️  Def: private
  └─ [1] 🔒 MODIFIER: Superfluid.onlyAgreement() (NodeID: 13)
      💬 Args: [no args]
    └─ [2] ⚙️ FUNCTION: Superfluid.isAgreementClassListed(contract ISuperAgreement) (NodeID: 14)
