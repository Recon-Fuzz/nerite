# Function: ctxUseCredit(bytes,int256)
...
```
┌─ [0] ⚙️ FUNCTION: Superfluid.ctxUseCredit(bytes,int256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │     👁️  Def: internal
  ├─ [1] 🔒 MODIFIER: Superfluid.assertValidCtx(bytes) (NodeID: 8)
  │   💬 Args: [ctx]
  │ └─ [2] ⚙️ FUNCTION: Superfluid._isCtxValid(bytes) (NodeID: 9)
  │     💬 Args: [ctx]
  │     👁️  Def: private
  └─ [1] 🔒 MODIFIER: Superfluid.onlyAgreement() (NodeID: 10)
      💬 Args: [no args]
    └─ [2] ⚙️ FUNCTION: Superfluid.isAgreementClassListed(contract ISuperAgreement) (NodeID: 11)
