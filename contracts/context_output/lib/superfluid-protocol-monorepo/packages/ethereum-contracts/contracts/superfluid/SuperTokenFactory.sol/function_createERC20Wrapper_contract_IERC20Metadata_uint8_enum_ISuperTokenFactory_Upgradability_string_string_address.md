# Function: createERC20Wrapper(contract IERC20Metadata,uint8,enum ISuperTokenFactory.Upgradability,string,string,address)
...
```
┌─ [0] ⚙️ FUNCTION: SuperTokenFactoryBase.createERC20Wrapper(contract IERC20Metadata,uint8,enum ISuperTokenFactory.Upgradability,string,string,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
