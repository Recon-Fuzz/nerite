# Function: registerAppWithKey(uint256,string)
...
```
┌─ [0] ⚙️ FUNCTION: Superfluid.registerAppWithKey(uint256,string) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: Superfluid._enforceAppRegistrationPermissioning(string,address) (NodeID: 1)
  │   💬 Args: [registrationKey, tx.origin]
  │   👁️  Def: internal
  ...
  └─ [1] ⚙️ FUNCTION: Superfluid._registerApp(contract ISuperApp,uint256) (NodeID: 3)
      💬 Args: [ISuperApp(msg.sender), configWord]
      👁️  Def: private
