# Function: operationTransferFrom(address,address,address,uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SuperToken.operationTransferFrom(address,address,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: SuperToken._transferFrom(address,address,address,uint256) (NodeID: 1)
  │   💬 Args: [account, spender, recipient, amount]
  │   👁️  Def: internal
