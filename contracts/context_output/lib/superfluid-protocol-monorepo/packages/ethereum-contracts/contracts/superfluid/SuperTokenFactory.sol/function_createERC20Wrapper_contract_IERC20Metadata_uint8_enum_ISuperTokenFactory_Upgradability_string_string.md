# Function: createERC20Wrapper(contract IERC20Metadata,uint8,enum ISuperTokenFactory.Upgradability,string,string)
...
function createERC20Wrapper(IERC20Metadata underlyingToken, uint8 underlyingDecimals, Upgradability upgradability, string calldata name, string calldata symbol) override external returns (ISuperToken superToken) {
    return createERC20Wrapper(underlyingToken, underlyingDecimals, upgradability, name, symbol, address(0));
}
```
...
```
┌─ [0] ⚙️ FUNCTION: SuperTokenFactoryBase.createERC20Wrapper(contract IERC20Metadata,uint8,enum ISuperTokenFactory.Upgradability,string,string) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: SuperTokenFactoryBase.createERC20Wrapper(contract IERC20Metadata,uint8,enum ISuperTokenFactory.Upgradability,string,string,address) (NodeID: 1)
      💬 Args: [underlyingToken, underlyingDecimals, upgradability, name, symbol, address(0)]
      👁️  Def: public
```
